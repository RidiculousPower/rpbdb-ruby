...
#include <rbdb/Rbdb_LockController.h>
...
void Init_Rbdb_LockController()	{
	...
	rb_define_singleton_method(	rb_Rbdb_LockController, 	"new",																													rb_Rbdb_LockController_new,																							-1 	);
	rb_define_method(						rb_Rbdb_LockController, 	"initialize",																										rb_Rbdb_LockController_initialize,																						-1 	);
                                                                                          		
	rb_define_method(						rb_Rbdb_LockController, 	"settings_controller",																					rb_Rbdb_LockController_settingsController,															0 	);
	rb_define_alias(						rb_Rbdb_LockController, 	"settings",																											"settings_controller"	);
	rb_define_alias(						rb_Rbdb_LockController, 	"set",																													"settings_controller"	);
	rb_define_alias(						rb_Rbdb_LockController, 	"set_to",																												"settings_controller"	);
	rb_define_alias(						rb_Rbdb_LockController, 	"is_set_to",																										"settings_controller"	);
	rb_define_method(						rb_Rbdb_LockController, 	"parent_environment",																						rb_Rbdb_LockController_parentEnvironment,																0 	);
	rb_define_alias(						rb_Rbdb_LockController, 	"environment",																									"parent_environment"	);

	rb_define_method(						rb_Rbdb_LockController, 	"locker_id",																										rb_Rbdb_LockController_lockerID,																				0 	);
	rb_define_alias(						rb_Rbdb_LockController, 	"id",																														"locker_id"	);
	rb_define_method(						rb_Rbdb_LockController, 	"create_lock",																									rb_Rbdb_LockController_createLock,																			0 	);
	rb_define_alias(						rb_Rbdb_LockController, 	"lock",																													"create_lock"	);
	rb_define_method(						rb_Rbdb_LockController, 	"queue_lock",																										rb_Rbdb_LockController_queueLock,																				0 	);
	rb_define_alias(						rb_Rbdb_LockController, 	"queue",																												"queue_lock"	);
	rb_define_method(						rb_Rbdb_LockController, 	"remove_lock_from_queue",																				rb_Rbdb_LockController_removeLockFromQueue,															0 	);
	rb_define_alias(						rb_Rbdb_LockController, 	"remove_from_queue",																						"remove_lock_from_queue"	);
	rb_define_method(						rb_Rbdb_LockController, 	"obtain_queued_locks",																					rb_Rbdb_LockController_obtainQueuedLocks,																0 	);
	rb_define_alias(						rb_Rbdb_LockController, 	"obtain_queued",																								"obtain_queued_locks"	);
	rb_define_method(						rb_Rbdb_LockController, 	"release_queued_locks",																					rb_Rbdb_LockController_releaseQueuedLocks,															0 	);
	rb_define_alias(						rb_Rbdb_LockController, 	"release_queued",																								"release_queued_locks"	);
	rb_define_method(						rb_Rbdb_LockController, 	"obtain_locks",																									rb_Rbdb_LockController_obtainLocks,																			0 	);
	rb_define_alias(						rb_Rbdb_LockController, 	"obtain",																												"obtain_locks"	);
	rb_define_method(						rb_Rbdb_LockController, 	"obtain_locks_and_override_timeout",														rb_Rbdb_LockController_obtainLocksAndOverrideTimeout,										0 	);
	rb_define_alias(						rb_Rbdb_LockController, 	"obtain_and_override_timeout",																	"obtain_locks_and_override_timeout"	);
	rb_define_alias(						rb_Rbdb_LockController, 	"override_timeout_and_obtain",																	"obtain_locks_and_override_timeout"	);
	rb_define_method(						rb_Rbdb_LockController, 	"release_locks",																								rb_Rbdb_LockController_releaseLocks,																		0 	);
	rb_define_alias(						rb_Rbdb_LockController, 	"release",																											"release_locks"	);

	//	what's the difference between releasing and closing locks?

	rb_define_method(						rb_Rbdb_LockController, 	"release_all_locks",																						rb_Rbdb_LockController_releaseAllLocks,																	0 	);
	rb_define_alias(						rb_Rbdb_LockController, 	"release_all",																									"release_all_locks"	);
	rb_define_method(						rb_Rbdb_LockController, 	"release_all_locks_on_object",																	rb_Rbdb_LockController_releaseAllLocksOnObject,													0 	);
	rb_define_method(						rb_Rbdb_LockController, 	"clear_default_locks",																					rb_Rbdb_LockController_clearDefaultLocks,																0 	);
	rb_define_alias(						rb_Rbdb_LockController, 	"clear_default",																								"clear_default_locks"	);
	rb_define_method(						rb_Rbdb_LockController, 	"clear_expired_locks",																					rb_Rbdb_LockController_clearExpiredLocks,																0 	);
	rb_define_alias(						rb_Rbdb_LockController, 	"clear_expired",																								"clear_expired_locks"	);
	rb_define_method(						rb_Rbdb_LockController, 	"clear_lock_request_for_locker_with_most_locks",								rb_Rbdb_LockController_clearLockRequestForLockerWithMostLocks,					0 	);
	rb_define_alias(						rb_Rbdb_LockController, 	"clear_request_for_most_locks",																	"clear_lock_request_for_locker_with_most_locks"	);
	rb_define_method(						rb_Rbdb_LockController, 	"clear_request_for_locker_with_most_write_locks",								rb_Rbdb_LockController_clearLockRequestForLockerWithMostWriteLocks,			0 	);
	rb_define_alias(						rb_Rbdb_LockController, 	"clear_request_for_most_write_locks",														"clear_request_for_locker_with_most_write_locks"	);

	rb_define_method(						rb_Rbdb_LockController, 	"clear_lock_request_for_locker_with_least_locks",								rb_Rbdb_LockController_clearLockRequestForLockerWithLeastLocks,					0 	);
	rb_define_alias(						rb_Rbdb_LockController, 	"clear_request_for_least",																			"clear_lock_request_for_locker_with_least_locks"	);
	rb_define_alias(						rb_Rbdb_LockController, 	"clear_least",																									"clear_lock_request_for_locker_with_least_locks"	);
	rb_define_method(						rb_Rbdb_LockController, 	"clear_lock_request_for_locker_with_least_write_locks",					rb_Rbdb_LockController_clearLockRequestForLockerWithLeastWriteLocks,		0 	);
	rb_define_alias(						rb_Rbdb_LockController, 	"clear_request_for_least_write",																"clear_lock_request_for_locker_with_least_write_locks"	);
	rb_define_alias(						rb_Rbdb_LockController, 	"clear_least_write",																						"clear_lock_request_for_locker_with_least_write_locks"	);
	rb_define_method(						rb_Rbdb_LockController, 	"clear_lock_request_for_locker_with_oldest_lock",								rb_Rbdb_LockController_clearLockRequestForLockerWithOldestLock,					0 	);
	rb_define_alias(						rb_Rbdb_LockController, 	"clear_request_for_oldest",																			"clear_lock_request_for_locker_with_oldest_lock"	);
	rb_define_alias(						rb_Rbdb_LockController, 	"clear_oldest",																									"clear_lock_request_for_locker_with_oldest_lock"	);
	rb_define_method(						rb_Rbdb_LockController, 	"clear_lock_request_for_locker_with_youngest_lock",							rb_Rbdb_LockController_clearLockRequestForLockerWithYoungestLock,				0 	);
	rb_define_alias(						rb_Rbdb_LockController, 	"clear_request_for_youngest",																		"clear_lock_request_for_locker_with_youngest_lock"	);
	rb_define_alias(						rb_Rbdb_LockController, 	"clear_youngest",																								"clear_lock_request_for_locker_with_youngest_lock"	);
	rb_define_method(						rb_Rbdb_LockController, 	"clear_lock_request_from_random_locker",												rb_Rbdb_LockController_clearLockRequestForRandomLocker,									0 	);
	rb_define_alias(						rb_Rbdb_LockController, 	"clear_request_from_random",																		"clear_lock_request_from_random_locker"	);
	rb_define_alias(						rb_Rbdb_LockController, 	"clear_random",																									"clear_lock_request_from_random_locker"	);
	rb_define_method(						rb_Rbdb_LockController, 	"close_all_locks",																							rb_Rbdb_LockController_closeAllLocks,																		0 	);
	rb_define_alias(						rb_Rbdb_LockController, 	"close_all",																										"close_all_locks"	);
...
VALUE rb_Rbdb_LockController_obtainLocks(	VALUE	rb_lock_controller,
	...
	Rbdb_LockController_obtainLocks(	c_lock_controller,
										c_locks_to_obtain,
...
VALUE rb_Rbdb_LockController_obtainLocksAndOverrideTimeout(	VALUE	rb_lock_controller,
	...
	Rbdb_LockController_obtainLocksAndOverrideTimeout(	c_lock_controller,
														c_locks_to_obtain,
														RARRAY_LEN( rb_locks_to_obtain ),
														c_timeout );
...
VALUE rb_Rbdb_LockController_releaseLocks(	VALUE	rb_lock_controller,
	...
	Rbdb_LockController_releaseLocks(	c_lock_controller,
										c_locks_to_release,
