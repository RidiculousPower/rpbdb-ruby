...
VALUE rb_Rbdb_DatabaseObject_internal_cursorObjectContextStorageHash( VALUE	rb_cursor_context_storage_hash,
	...
	void rb_Rbdb_DatabaseObject_internal_storeEnvironment(	VALUE	rb_self,
														   VALUE	rb_environment	);
	VALUE rb_Rbdb_DatabaseObject_internal_getEnvironment(	VALUE	rb_self );
	void rb_Rbdb_DatabaseObject_internal_storeDatabase(	VALUE	rb_self,
														VALUE	rb_database,
	...
	VALUE rb_Rbdb_DatabaseObject_internal_getObjectFromClassInstanceHash(	VALUE	rb_self,
																		  char*	rb_class_instance_hash_name,
																		  VALUE	rb_index_method );
VALUE rb_Rbdb_DatabaseObject_mergedInitializeArguments(	int		argc,
														VALUE*	args,
														VALUE	rb_self );
void rb_Rbdb_DatabaseObject_internal_packRubyObjectForDatabaseStorage(	VALUE		rb_key,
																																				DBT*		c_key_dbt,
																																				BOOL		c_convert_string_encoding );
	VALUE rb_Rbdb_DatabaseObject_internal_unpackRubyObjectFromDatabaseStorage( VALUE		rb_message_packed_string );
...
VALUE rb_Rbdb_DatabaseObject_internal_extractRetrievalKey( Rbdb_Record* c_retrieval_record );
	...
	VALUE rb_Rbdb_DatabaseObject_internal_retrieveEachOfMultipleFromParameters(	int	argc,
																					VALUE*	args,
																					VALUE	rb_klass_self );
	VALUE rb_Rbdb_DatabaseObject_internal_retrieveSelfAsPrimaryPackedDataFromParameterDescription(	VALUE	rb_self,
																											VALUE	rb_unique_key_parameter );
	VALUE rb_Rbdb_DatabaseObject_internal_retrieveEachOfMultipleFromParameterDataArray(	VALUE	rb_self,
																										VALUE	rb_unique_key_parameter );
	VALUE rb_Rbdb_DatabaseObject_internal_retrieveSelfAsPrimaryPackedDataHash(	VALUE	rb_self,
																									   VALUE	rb_unique_key_parameter );
	VALUE rb_Rbdb_DatabaseObject_internal_retrieveSelfAsPrimaryPackedDataPrimaryKey(	VALUE	rb_self,
																											 VALUE	rb_unique_key_parameter );
	VALUE rb_Rbdb_DatabaseObject_internal_retrieveSelfAsPrimaryPackedDataMethodValueKeyHash(	VALUE	rb_self,
																													 VALUE	rb_unique_key_parameter );
	VALUE rb_Rbdb_DatabaseObject_internal_retrieveSelfAsPrimaryPackedDataSecondaryKey(	VALUE	rb_self,
																											   VALUE	rb_unique_key_parameter );
	VALUE rb_Rbdb_DatabaseObject_internal_retrieveSelfAsPrimaryPackedDataUniqueKey(	VALUE	rb_self,
																											VALUE	rb_unique_key_parameter );
	VALUE rb_Rbdb_DatabaseObject_internal_createTemporaryRetrievalObjectFromParameterDescription(	VALUE	rb_self,
																								  VALUE	rb_key_method_symbol_or_string,
																								  VALUE	rb_key_value );
	VALUE rb_Rbdb_DatabaseObject_internal_retrieveCursorForParameterDescription(	VALUE	rb_self,
																								   VALUE	rb_key_method_symbol,
																								   VALUE	rb_key_value );
	VALUE rb_Rbdb_DatabaseObject_internal_retrieveSelfAsPrimaryPackedData( VALUE	rb_self );
	VALUE rb_Rbdb_DatabaseObject_internal_verifyObjectAsEnvironment( VALUE rb_object );
	VALUE rb_Rbdb_DatabaseObject_internal_verifyObjectAsDatabase( VALUE rb_object );
	void rb_Rbdb_DatabaseObject_internal_requireObjectVerifyAsEnvironment( VALUE rb_object );
