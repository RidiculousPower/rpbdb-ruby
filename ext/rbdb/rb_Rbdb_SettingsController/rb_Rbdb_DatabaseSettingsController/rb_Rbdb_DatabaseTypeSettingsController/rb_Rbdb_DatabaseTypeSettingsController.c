...
void Init_Rbdb_DatabaseTypeSettingsController()	{
	...
	rb_Rbdb_DatabaseTypeSettingsController			=	rb_define_class_under(	rb_Rbdb_DatabaseSettingsController, 
																																				"Type",	
																																				rb_cObject );

	rb_define_singleton_method(	rb_Rbdb_DatabaseTypeSettingsController, 	"new",										rb_Rbdb_DatabaseTypeSettingsController_new,									-1 	);
	rb_define_method(						rb_Rbdb_DatabaseTypeSettingsController, 	"initialize",							rb_Rbdb_DatabaseTypeSettingsController_initialize,								-1 	);
                    					
	rb_define_method(						rb_Rbdb_DatabaseTypeSettingsController, 	"parent_environment",			rb_Rbdb_DatabaseTypeSettingsController_parentEnvironment,		0 	);
	rb_define_alias(						rb_Rbdb_DatabaseTypeSettingsController, 	"environment",						"parent_environment"	);
	rb_define_method(						rb_Rbdb_DatabaseTypeSettingsController, 	"parent_database",				rb_Rbdb_DatabaseTypeSettingsController_parentDatabase,			0 	);
	rb_define_alias(						rb_Rbdb_DatabaseTypeSettingsController, 	"database",								"parent_database"	);
	rb_define_method(						rb_Rbdb_DatabaseTypeSettingsController, 	"parent_settings_controller",				rb_Rbdb_DatabaseTypeSettingsController_parentSettingsController,			0 	);
	rb_define_method(						rb_Rbdb_DatabaseTypeSettingsController, 	"parent_database_settings_controller",				rb_Rbdb_DatabaseTypeSettingsController_parentDatabaseSettingsController,			0 	);
                    					
	rb_define_method(						rb_Rbdb_DatabaseTypeSettingsController, 	"database_type",					rb_Rbdb_DatabaseTypeSettingsController_databaseType,				0 	);
	rb_define_alias(						rb_Rbdb_DatabaseTypeSettingsController, 	"type",										"database_type"	);
                    					
	rb_define_method(						rb_Rbdb_DatabaseTypeSettingsController, 	"is_btree?",							rb_Rbdb_DatabaseTypeSettingsController_isBTree,							0 	);
	rb_define_method(						rb_Rbdb_DatabaseTypeSettingsController, 	"set_type_to_btree",			rb_Rbdb_DatabaseTypeSettingsController_setTypeToBTree,			0 	);
                    					
	rb_define_method(						rb_Rbdb_DatabaseTypeSettingsController, 	"is_hash?",								rb_Rbdb_DatabaseTypeSettingsController_isHash,							0 	);
	rb_define_method(						rb_Rbdb_DatabaseTypeSettingsController, 	"set_type_to_hash",				rb_Rbdb_DatabaseTypeSettingsController_setTypeToHash,				0 	);
                    					
	rb_define_method(						rb_Rbdb_DatabaseTypeSettingsController, 	"is_recno?",							rb_Rbdb_DatabaseTypeSettingsController_isRecno,							0 	);
	rb_define_method(						rb_Rbdb_DatabaseTypeSettingsController, 	"set_type_to_recno",			rb_Rbdb_DatabaseTypeSettingsController_setTypeToRecno,			0 	);
                    					
	rb_define_method(						rb_Rbdb_DatabaseTypeSettingsController, 	"is_queue?",							rb_Rbdb_DatabaseTypeSettingsController_isQueue,							0 	);
	rb_define_method(						rb_Rbdb_DatabaseTypeSettingsController, 	"set_type_to_queue",			rb_Rbdb_DatabaseTypeSettingsController_setTypeToQueue,			0 	);
                    					
	rb_define_method(						rb_Rbdb_DatabaseTypeSettingsController, 	"btree_settings_controller",				rb_Rbdb_DatabaseTypeSettingsController_btreeController,			0 	);
	rb_define_alias(						rb_Rbdb_DatabaseTypeSettingsController, 	"btree",									"btree_settings_controller"	);

	rb_define_method(						rb_Rbdb_DatabaseTypeSettingsController, 	"hash_settings_controller",				rb_Rbdb_DatabaseTypeSettingsController_hashController,			0 	);
	rb_define_alias(						rb_Rbdb_DatabaseTypeSettingsController, 	"hash",										"hash_settings_controller"	);

	rb_define_method(						rb_Rbdb_DatabaseTypeSettingsController, 	"queue_settings_controller",				rb_Rbdb_DatabaseTypeSettingsController_queueController,			0 	);
	rb_define_alias(						rb_Rbdb_DatabaseTypeSettingsController, 	"queue",									"queue_settings_controller"	);

	rb_define_method(						rb_Rbdb_DatabaseTypeSettingsController, 	"recno_settings_controller",				rb_Rbdb_DatabaseTypeSettingsController_recnoController,			0 	);
	rb_define_alias(						rb_Rbdb_DatabaseTypeSettingsController, 	"recno",									"recno_settings_controller"	);
...
VALUE rb_Rbdb_DatabaseTypeSettingsController_new(	int			argc,
	...
	if ( rb_parent_database != Qnil )	{
		...
		const DBTYPE	c_database_type	=	Rbdb_DatabaseTypeSettingsController_databaseType( c_database_type_settings_controller );

		VALUE	rb_database_specific_type_settings_controller	=	Qnil;
		switch( c_database_type )	{
			
			case DB_BTREE:
				rb_database_specific_type_settings_controller	=	rb_Rbdb_DatabaseTypeBtreeSettingsController_new(	1,
																																																					& rb_parent_database,
																																																					rb_Rbdb_DatabaseTypeBtreeSettingsController );
				break;
				
			case DB_HASH:
				rb_database_specific_type_settings_controller	=	rb_Rbdb_DatabaseTypeHashSettingsController_new(		1,
																																																					& rb_parent_database,
																																																					rb_Rbdb_DatabaseTypeHashSettingsController );				
				break;
			
			case DB_QUEUE:
				rb_database_specific_type_settings_controller	=	rb_Rbdb_DatabaseTypeQueueSettingsController_new(	1,
																																																					& rb_parent_database,
																																																					rb_Rbdb_DatabaseTypeQueueSettingsController );
				break;
			
			case DB_RECNO:
				rb_database_specific_type_settings_controller	=	rb_Rbdb_DatabaseTypeRecnoSettingsController_new(	1,
																																																					& rb_parent_database,
		...
		rb_define_method(		rb_database_specific_type_settings_controller_singleton_class, 	"database_type",					rb_Rbdb_DatabaseTypeSettingsController_databaseType,				0 	);
		rb_define_alias(		rb_database_specific_type_settings_controller_singleton_class, 	"type",										"database_type"	);
		rb_define_method(		rb_database_specific_type_settings_controller_singleton_class, 	"is_btree?",							rb_Rbdb_DatabaseTypeSettingsController_isBTree,							0 	);
		rb_define_method(		rb_database_specific_type_settings_controller_singleton_class, 	"is_hash?",								rb_Rbdb_DatabaseTypeSettingsController_isHash,							0 	);
		rb_define_method(		rb_database_specific_type_settings_controller_singleton_class, 	"is_queue?",							rb_Rbdb_DatabaseTypeSettingsController_isQueue,							0 	);
		rb_define_method(		rb_database_specific_type_settings_controller_singleton_class, 	"is_recno?",							rb_Rbdb_DatabaseTypeSettingsController_isRecno,							0 	);
...
VALUE rb_Rbdb_DatabaseTypeSettingsController_parentEnvironment(	VALUE	rb_database_type_settings_controller )	{
	...
	VALUE	rb_parent_database_settings_controller		=	rb_Rbdb_DatabaseTypeSettingsController_parentDatabaseSettingsController( rb_database_type_settings_controller );
...
VALUE rb_Rbdb_DatabaseTypeSettingsController_databaseType( VALUE	rb_database_type_settings_controller )	{
	...
	if ( rb_ary_includes( rb_ancestors, rb_Rbdb_DatabaseTypeSettingsController ) == Qtrue )	{
		...
		switch( c_database_type )	{
			...
			case DB_BTREE:
				rb_database_type	=	rb_Rbdb_DatabaseBtreeType_const;
				break;
				
			case DB_HASH:
				rb_database_type	=	rb_Rbdb_DatabaseHashType_const;
				break;
			
			case DB_QUEUE:
				rb_database_type	=	rb_Rbdb_DatabaseQueueType_const;
				break;
			
			case DB_RECNO:
				rb_database_type	=	rb_Rbdb_DatabaseRecnoType_const;
				break;
		...
		if (			rb_ary_includes( rb_ancestors, rb_Rbdb_DatabaseTypeBtreeSettingsController ) == Qtrue )	{
			rb_database_type	=	rb_Rbdb_DatabaseBtreeType_const;
		}
		else if ( rb_ary_includes( rb_ancestors, rb_Rbdb_DatabaseTypeHashSettingsController ) == Qtrue )	{
			rb_database_type	=	rb_Rbdb_DatabaseHashType_const;
		}
		else if ( rb_ary_includes( rb_ancestors, rb_Rbdb_DatabaseTypeQueueSettingsController ) == Qtrue )	{
			rb_database_type	=	rb_Rbdb_DatabaseQueueType_const;
		}
		else if ( rb_ary_includes( rb_ancestors, rb_Rbdb_DatabaseTypeRecnoSettingsController ) == Qtrue )	{
			rb_database_type	=	rb_Rbdb_DatabaseRecnoType_const;
		}
		else {
			rb_raise( rb_eRuntimeError, "Database was of unknown type." );
...
VALUE rb_Rbdb_DatabaseTypeSettingsController_isBTree( VALUE		rb_database_type_settings_controller )	{
	...
	VALUE	rb_database_type	=	rb_Rbdb_DatabaseTypeSettingsController_databaseType( rb_database_type_settings_controller );
	
	VALUE	rb_is_type				=	( rb_database_type == rb_Rbdb_DatabaseBtreeType_const ? Qtrue : Qfalse );
...
VALUE rb_Rbdb_DatabaseTypeSettingsController_isHash(	VALUE		rb_database_type_settings_controller )	{
	...
	VALUE	rb_is_type				=	( rb_database_type == rb_Rbdb_DatabaseHashType_const ? Qtrue : Qfalse );
...
VALUE rb_Rbdb_DatabaseTypeSettingsController_isRecno(	VALUE		rb_database_type_settings_controller )	{
	...
	VALUE	rb_is_type				=	( rb_database_type == rb_Rbdb_DatabaseRecnoType_const ? Qtrue : Qfalse );
...
VALUE rb_Rbdb_DatabaseTypeSettingsController_isQueue( VALUE		rb_database_type_settings_controller )	{
	...
	VALUE	rb_is_type				=	( rb_database_type == rb_Rbdb_DatabaseQueueType_const ? Qtrue : Qfalse );
