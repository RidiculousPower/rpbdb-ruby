...
void Init_RPDB_LockController()	{
	...
	rb_define_method(						rb_RPDB_LockController, 	"initialize",																										rb_RPDB_LockController_initialize,																						-1 	);
...
VALUE rb_RPDB_LockController_initialize(	int				argc __attribute__ ((unused)),
