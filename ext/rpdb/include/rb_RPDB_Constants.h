	...
	****************************/
	...
	#define RUBY_RPDB_DATABASE_CURSOR_READ_WRITE_SETTINGS_CONTROLLER( c_database_cursor_read_write_settings_controller )																	  RUBY_RPDB_OBJECT(	c_database_cursor_read_write_settings_controller, rb_RPDB_DatabaseCursorReadWriteSettingsController, NULL, NULL )
	#define C_RPDB_DATABASE_CURSOR_READ_WRITE_SETTINGS_CONTROLLER( rb_database_cursor_read_write_settings_controller, c_database_cursor_read_write_settings_controller )					  C_RPDB_STRUCT(		rb_database_cursor_read_write_settings_controller, c_database_cursor_read_write_settings_controller, RPDB_DatabaseCursorReadWriteSettingsController )
	...
	#define RUBY_RPDB_DATABASE_FIXED_RECORD_SETTINGS_CONTROLLER( c_database_fixed_record_settings_controller )																				  RUBY_RPDB_OBJECT(	c_database_fixed_record_settings_controller, rb_RPDB_DatabaseFixedRecordSettingsController, NULL, NULL )
	#define C_RPDB_DATABASE_FIXED_RECORD_SETTINGS_CONTROLLER( rb_database_fixed_record_settings_controller, c_database_fixed_record_settings_controller )									  C_RPDB_STRUCT(		rb_database_fixed_record_settings_controller, c_database_fixed_record_settings_controller, RPDB_DatabaseFixedRecordSettingsController )
	...
	#define RUBY_RPDB_DATABASE_READ_WRITE_SETTINGS_CONTROLLER( c_database_read_write_settings_controller )																					  RUBY_RPDB_OBJECT(	c_database_read_write_settings_controller, rb_RPDB_DatabaseReadWriteSettingsController, NULL, NULL )
	#define C_RPDB_DATABASE_READ_WRITE_SETTINGS_CONTROLLER( rb_database_read_write_settings_controller, c_database_read_write_settings_controller )										  C_RPDB_STRUCT(		rb_database_read_write_settings_controller, c_database_read_write_settings_controller, RPDB_DatabaseReadWriteSettingsController )
	...
	#define RUBY_RPDB_DATABASE_VARIABLE_RECORD_SETTINGS_CONTROLLER( c_database_variable_record_settings_controller )																		  RUBY_RPDB_OBJECT(	c_database_variable_record_settings_controller, rb_RPDB_DatabaseVariableRecordSettingsController, NULL, NULL )
	#define C_RPDB_DATABASE_VARIABLE_RECORD_SETTINGS_CONTROLLER( rb_database_variable_record_settings_controller, c_database_variable_record_settings_controller )							  C_RPDB_STRUCT(		rb_database_variable_record_settings_controller, c_database_variable_record_settings_controller, RPDB_DatabaseVariableRecordSettingsController )
	...
	#define RUBY_RPDB_MEMORY_POOL_READ_WRITE_SETTINGS_CONTROLLER( c_memory_pool_read_write_settings_controller )																			  RUBY_RPDB_OBJECT(	c_memory_pool_read_write_settings_controller, rb_RPDB_MemoryPoolReadWriteSettingsController, NULL, NULL )
	#define C_RPDB_MEMORY_POOL_READ_WRITE_SETTINGS_CONTROLLER( rb_memory_pool_read_write_settings_controller, c_memory_pool_read_write_settings_controller )								  C_RPDB_STRUCT(		rb_memory_pool_read_write_settings_controller, c_memory_pool_read_write_settings_controller, RPDB_MemoryPoolReadWriteSettingsController )
