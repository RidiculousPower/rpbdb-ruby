	...
	#define RPDB_RB_DATABASE_SEQUENCE_CONTROLLER_VARIABLE_PARENT_DATABASE												"@parent_database"

	//	Database Sequence
	#define RPDB_RB_DATABASE_SEQUENCE_VARIABLE_PARENT_SEQUENCE_CONTROLLER								"@parent_sequence_controller"
	...
	#define RPDB_RB_MEMORY_POOL_FILE_PAGE_VARIABLE_PARENT_MEMORY_POOL_FILE_PAGE_CONTROLLER					"@parent_memory_pool_file_page_controller"
	...
	//	Settings Controller
	#define RPDB_RB_SETTINGS_CONTROLLER_VARIABLE_PARENT_ENVIRONMENT									"@parent_environment"
	...
	#define RPDB_RB_DATABASE_TYPE_BTREE_SETTINGS_CONTROLLER_VARIABLE_PARENT_DATABASE_SETTINGS_CONTROLLER											"@parent_database_settings_controller"
	...
	#define RPDB_RB_DATABASE_TYPE_HASH_SETTINGS_CONTROLLER_VARIABLE_PARENT_DATABASE_SETTINGS_CONTROLLER												"@parent_database_settings_controller"
	...
	#define RPDB_RB_DATABASE_TYPE_RECNO_SETTINGS_CONTROLLER_VARIABLE_PARENT_DATABASE_SETTINGS_CONTROLLER												"@parent_database_settings_controller"
	...
	#define RPDB_RB_DATABASE_TYPE_QUEUE_SETTINGS_CONTROLLER_VARIABLE_PARENT_DATABASE_SETTINGS_CONTROLLER											"@parent_database_settings_controller"
	...
	#define RPDB_RB_DEBUG_VERBOSITY_SETTINGS_CONTROLLER_VARIABLE_PARENT_DEBUG_SETTINGS_CONTROLLER									"@parent_debug_settings_controller"
	...
	#define RPDB_RB_ENVIRONMENT_CACHE_SETTINGS_CONTROLLER_VARIABLE_PARENT_SETTINGS_CONTROLLER									"@parent_settings_controller"
	...
	#define RPDB_RB_FILE_VERBOSITY_SETTINGS_CONTROLLER_VARIABLE_PARENT_FILE_SETTINGS_CONTROLLER									"@parent_file_settings_controller"
	...
	#define RPDB_RB_LOCK_DEADLOCK_DETECTOR_SETTINGS_CONTROLLER_VARIABLE_PARENT_LOCK_SETTINGS_CONTROLLER									"@parent_lock_settings_controller"
	
	//	Lock Deadlock Detector Verbosity Settings Controller
	#define RPDB_RB_LOCK_DEADLOCK_DETECTOR_VERBOSITY_SETTINGS_CONTROLLER_VARIABLE_PARENT_LOCK_DEADLOCK_DETECTOR_SETTINGS_CONTROLLER									"@parent_lock_deadlock_detector_settings_controller"
	
	//	Log Settings Controller
	#define RPDB_RB_LOG_SETTINGS_CONTROLLER_VARIABLE_PARENT_SETTINGS_CONTROLLER																						"@parent_settings_controller"
	...
	#define RPDB_RB_MEMORY_POOL_READ_WRITE_SETTINGS_CONTROLLER_VARIABLE_PARENT_MEMORY_POOL_SETTINGS_CONTROLLER									"@parent_memory_pool_settings_controller"

	//	Memory Pool File Settings Controller
	#define RPDB_RB_MEMORY_POOL_FILE_SETTINGS_CONTROLLER_VARIABLE_PARENT_MEMORY_POOL_SETTINGS_CONTROLLER									"@parent_memory_pool_settings_controller"

	//	Memory Pool File Page Settings Controller
	#define RPDB_RB_MEMORY_POOL_FILE_PAGE_SETTINGS_CONTROLLER_VARIABLE_PARENT_MEMORY_POOL_FILE_SETTINGS_CONTROLLER									"@parent_memory_pool_file_settings_controller"

	//	Memory Pool File Cache Settings Controller
	#define RPDB_RB_MEMORY_POOL_FILE_CACHE_SETTINGS_CONTROLLER_VARIABLE_PARENT_MEMORY_POOL_FILE_SETTINGS_CONTROLLER									"@parent_memory_pool_file_settings_controller"

	//	Memory Pool File Cache Priority Settings Controller
	#define RPDB_RB_MEMORY_POOL_FILE_CACHE_PRIORITY_SETTINGS_CONTROLLER_VARIABLE_PARENT_MEMORY_POOL_FILE_CACHE_SETTINGS_CONTROLLER									"@parent_memory_pool_file_cache_settings_controller"
	...
	#define RPDB_RB_REPLICATION_ELECTION_SETTINGS_CONTROLLER_VARIABLE_PARENT_REPLICATION_SETTINGS_CONTROLLER									"@parent_replication_settings_controller"

	//	Replication Timeout Settings Controller
	#define RPDB_RB_REPLICATION_TIMEOUT_SETTINGS_CONTROLLER_VARIABLE_PARENT_REPLICATION_SETTINGS_CONTROLLER									"@parent_replication_settings_controller"

	//	Replication Verbosity Settings Controller
	#define RPDB_RB_REPLICATION_VERBOSITY_SETTINGS_CONTROLLER_VARIABLE_PARENT_REPLICATION_SETTINGS_CONTROLLER									"@parent_replication_settings_controller"
	...
	#define RPDB_RB_SETTINGS_VARIABLE_FILE_VERBOSITY_SETTINGS_CONTROLLER					"@file_verbosity_settings_controller"
	...
	#define RPDB_RB_SETTINGS_VARIABLE_LOCK_DEADLOCK_DETECTOR_SETTINGS_CONTROLLER										"@lock_deadlock_detector_settings_controller"
	#define RPDB_RB_SETTINGS_VARIABLE_LOCK_DEADLOCK_DETECTOR_VERBOSITY_SETTINGS_CONTROLLER										"@lock_deadlock_detector_verbosity_settings_controller"
	...
	#define RPDB_RB_SETTINGS_VARIABLE_REPLICATION_ELECTION_SETTINGS_CONTROLLER							"@replication_election_settings_controller"
	#define RPDB_RB_SETTINGS_VARIABLE_REPLICATION_TIMEOUT_SETTINGS_CONTROLLER							"@replication_timeout_settings_controller"
	#define RPDB_RB_SETTINGS_VARIABLE_REPLICATION_VERBOSITY_SETTINGS_CONTROLLER							"@replication_verbosity_settings_controller"
	#define RPDB_RB_SETTINGS_VARIABLE_MEMORY_POOL_SETTINGS_CONTROLLER							"@memory_pool_settings_controller"
	#define RPDB_RB_SETTINGS_VARIABLE_MEMORY_POOL_READ_WRITE_SETTINGS_CONTROLLER							"@memory_pool_read_write_settings_controller"
	#define RPDB_RB_SETTINGS_VARIABLE_MEMORY_POOL_FILE_SETTINGS_CONTROLLER				"@memory_pool_file_settings_controller"
	#define RPDB_RB_SETTINGS_VARIABLE_MEMORY_POOL_FILE_PAGE_SETTINGS_CONTROLLER		"@memory_pool_file_page_settings_controller"
	#define RPDB_RB_SETTINGS_VARIABLE_MEMORY_POOL_FILE_CACHE_SETTINGS_CONTROLLER		"@memory_pool_file_cache_settings_controller"
	#define RPDB_RB_SETTINGS_VARIABLE_MEMORY_POOL_FILE_CACHE_PRIORITY_SETTINGS_CONTROLLER		"@memory_pool_file_cache_priority_settings_controller"
	...
	#define RPDB_RB_SETTINGS_VARIABLE_DATABASE_CACHE_PRIORITY_SETTINGS_CONTROLLER					"@database_cache_priority_settings_controller"
	#define RPDB_RB_SETTINGS_VARIABLE_DATABASE_CURSOR_CACHE_SETTINGS_CONTROLLER					"@database_cursor_cache_settings_controller"
	#define RPDB_RB_SETTINGS_VARIABLE_DATABASE_CURSOR_CACHE_PRIORITY_SETTINGS_CONTROLLER					"@database_cursor_cache_priority_settings_controller"
	#define RPDB_RB_SETTINGS_VARIABLE_DATABASE_CURSOR_SETTINGS_CONTROLLER					"@database_cursor_settings_controller"
	#define RPDB_RB_SETTINGS_VARIABLE_DATABASE_CURSOR_READ_WRITE_SETTINGS_CONTROLLER					"@database_cursor_read_write_settings_controller"
	#define RPDB_RB_SETTINGS_VARIABLE_DATABASE_ERROR_SETTINGS_CONTROLLER					"@database_error_settings_controller"
	#define RPDB_RB_SETTINGS_VARIABLE_DATABASE_RECORD_SETTINGS_CONTROLLER								"@database_record_settings_controller"
	#define RPDB_RB_SETTINGS_VARIABLE_DATABASE_RECORD_FIXED_LENGTH_SETTINGS_CONTROLLER								"@database_record_fixed_length_settings_controller"
	#define RPDB_RB_SETTINGS_VARIABLE_DATABASE_RECORD_VARIABLE_LENGTH_SETTINGS_CONTROLLER								"@database_record_variable_length_settings_controller"
	#define RPDB_RB_SETTINGS_VARIABLE_DATABASE_RECORD_READ_WRITE_SETTINGS_CONTROLLER								"@database_record_read_write_settings_controller"
	#define RPDB_RB_SETTINGS_VARIABLE_DATABASE_READ_WRITE_SETTINGS_CONTROLLER								"@database_read_write_settings_controller"
	#define RPDB_RB_SETTINGS_VARIABLE_DATABASE_TYPE_SETTINGS_CONTROLLER								"@database_type_settings_controller"
	#define RPDB_RB_SETTINGS_VARIABLE_DATABASE_TYPE_BTREE_SETTINGS_CONTROLLER								"@database_type_btree_settings_controller"
	#define RPDB_RB_SETTINGS_VARIABLE_DATABASE_TYPE_HASH_SETTINGS_CONTROLLER								"@database_type_hash_settings_controller"
	#define RPDB_RB_SETTINGS_VARIABLE_DATABASE_TYPE_QUEUE_SETTINGS_CONTROLLER								"@database_type_queue_settings_controller"
	#define RPDB_RB_SETTINGS_VARIABLE_DATABASE_TYPE_RECNO_SETTINGS_CONTROLLER								"@database_type_recno_settings_controller"
	...
	#define RPDB_RB_SETTINGS_VARIABLE_DEBUG_SETTINGS_CONTROLLER									"@database_debug_settings_controller"
	#define RPDB_RB_SETTINGS_VARIABLE_DEBUG_VERBOSITY_SETTINGS_CONTROLLER									"@database_debug_verbosity_settings_controller"
