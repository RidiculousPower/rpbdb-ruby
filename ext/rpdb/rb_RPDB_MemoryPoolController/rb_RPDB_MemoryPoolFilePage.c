...
VALUE rb_RPDB_MemoryPoolFilePage_new( VALUE	klass __attribute__ ((unused)),
	...
	argv[ 0 ]	=	rb_memory_pool_file_page_controller;
...
VALUE rb_RPDB_MemoryPoolFilePage_init(	VALUE	rb_memory_pool_file_page,
																				VALUE	rb_memory_pool_file_page_controller __attribute__ ((unused)) )	{
