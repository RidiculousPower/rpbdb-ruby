...
void Init_RPDB_MemoryPoolFileCacheSettingsController()	{
	...
	rb_define_method(						rb_RPDB_MemoryPoolFileCacheSettingsController,				"parent_settings_controller",					rb_RPDB_MemoryPoolFileCacheSettingsController_parentSettingsController,								0 	);
...
VALUE rb_RPDB_MemoryPoolFileCacheSettingsController_prioritySettingsController( VALUE	rb_memory_pool_file_cache_settings_controller )	{
	...
	if ( ( rb_memory_pool_file_cache_priority_settings_controller = rb_iv_get(	rb_memory_pool_file_cache_settings_controller,
																																							RPDB_RB_SETTINGS_VARIABLE_MEMORY_POOL_FILE_CACHE_PRIORITY_SETTINGS_CONTROLLER ) == Qnil ) )	{
	
		rb_memory_pool_file_cache_priority_settings_controller	=	rb_RPDB_MemoryPoolFileCachePrioritySettingsController_new(	1,
																																																													& rb_memory_pool_file_cache_settings_controller,
																																																													rb_RPDB_MemoryPoolFileCachePrioritySettingsController );
		rb_iv_set(	rb_memory_pool_file_cache_priority_settings_controller,
								RPDB_RB_SETTINGS_VARIABLE_MEMORY_POOL_FILE_CACHE_PRIORITY_SETTINGS_CONTROLLER,
								rb_memory_pool_file_cache_settings_controller );
	}
