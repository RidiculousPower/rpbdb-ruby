...
void Init_RPDB_TransactionSettingsController()	{
	...
	rb_define_method(			rb_RPDB_TransactionSettingsController, 				"shm_key",														rb_RPDB_TransactionSettingsController_on,													0 	);
	rb_define_method(			rb_RPDB_TransactionSettingsController, 				"shm_key",														rb_RPDB_TransactionSettingsController_off,													0 	);
	rb_define_method(			rb_RPDB_TransactionSettingsController, 				"shm_key",														rb_RPDB_TransactionSettingsController_turnOn,													0 	);
	rb_define_method(			rb_RPDB_TransactionSettingsController, 				"shm_key",														rb_RPDB_TransactionSettingsController_turnOff,													0 	);
	rb_define_method(			rb_RPDB_TransactionSettingsController, 				"shm_key",														rb_RPDB_TransactionSettingsController_prohibitSyncOnWrite,													0 	);
	rb_define_method(			rb_RPDB_TransactionSettingsController, 				"shm_key",														rb_RPDB_TransactionSettingsController_turnProhibitSyncOnWriteTransactionOn,													0 	);
	rb_define_method(			rb_RPDB_TransactionSettingsController, 				"shm_key",														rb_RPDB_TransactionSettingsController_turnProhibitSyncOnWriteTransactionOff,													0 	);
	rb_define_method(			rb_RPDB_TransactionSettingsController, 				"shm_key",														rb_RPDB_TransactionSettingsController_prohibitSyncOnCommit,													0 	);
	rb_define_method(			rb_RPDB_TransactionSettingsController, 				"shm_key",														rb_RPDB_TransactionSettingsController_turnProhibitSyncOnCommitOn,													0 	);
	rb_define_method(			rb_RPDB_TransactionSettingsController, 				"shm_key",														rb_RPDB_TransactionSettingsController_turnProhibitSyncOnCommitOff,													0 	);
	rb_define_method(			rb_RPDB_TransactionSettingsController, 				"shm_key",														rb_RPDB_TransactionSettingsController_timeoutInMicrosecondsReturnsDenyNotDeadlock,													0 	);
	rb_define_method(			rb_RPDB_TransactionSettingsController, 				"shm_key",														rb_RPDB_TransactionSettingsController_turnTimeoutInMicrosecondsReturnsDenyNotDeadlockOn,													0 	);
	rb_define_method(			rb_RPDB_TransactionSettingsController, 				"shm_key",														rb_RPDB_TransactionSettingsController_turnTimeoutInMicrosecondsReturnsDenyNotDeadlockOff,													0 	);
	rb_define_method(			rb_RPDB_TransactionSettingsController, 				"shm_key",														rb_RPDB_TransactionSettingsController_concurrentDataStoreLocking,													0 	);
	rb_define_method(			rb_RPDB_TransactionSettingsController, 				"shm_key",														rb_RPDB_TransactionSettingsController_turnConcurrentDataStoreLockingOn,													0 	);
	rb_define_method(			rb_RPDB_TransactionSettingsController, 				"shm_key",														rb_RPDB_TransactionSettingsController_turnConcurrentDataStoreLockingOff,													0 	);
	rb_define_method(			rb_RPDB_TransactionSettingsController, 				"shm_key",														rb_RPDB_TransactionSettingsController_snapshotIsolation,													0 	);
	rb_define_method(			rb_RPDB_TransactionSettingsController, 				"shm_key",														rb_RPDB_TransactionSettingsController_turnSnapshotIsolationOn,													0 	);
	rb_define_method(			rb_RPDB_TransactionSettingsController, 				"shm_key",														rb_RPDB_TransactionSettingsController_turnSnapshotIsolationOff,													0 	);
	rb_define_method(			rb_RPDB_TransactionSettingsController, 				"shm_key",														rb_RPDB_TransactionSettingsController_degreeOneIsolation,													0 	);
	rb_define_method(			rb_RPDB_TransactionSettingsController, 				"shm_key",														rb_RPDB_TransactionSettingsController_turnDegreeOneIsolationOn,													0 	);
	rb_define_method(			rb_RPDB_TransactionSettingsController, 				"shm_key",														rb_RPDB_TransactionSettingsController_turnDegreeOneIsolationOff,													0 	);
	rb_define_method(			rb_RPDB_TransactionSettingsController, 				"shm_key",														rb_RPDB_TransactionSettingsController_degreeTwoIsolation,													0 	);
	rb_define_method(			rb_RPDB_TransactionSettingsController, 				"shm_key",														rb_RPDB_TransactionSettingsController_turnDegreeTwoIsolationOn,													0 	);
	rb_define_method(			rb_RPDB_TransactionSettingsController, 				"shm_key",														rb_RPDB_TransactionSettingsController_turnDegreeTwoIsolationOff,													0 	);
	rb_define_method(			rb_RPDB_TransactionSettingsController, 				"shm_key",														rb_RPDB_TransactionSettingsController_encloseAllActivityInTransaction,													0 	);
	rb_define_method(			rb_RPDB_TransactionSettingsController, 				"shm_key",														rb_RPDB_TransactionSettingsController_turnEncloseAllActivityInTransactionOn,													0 	);
	rb_define_method(			rb_RPDB_TransactionSettingsController, 				"shm_key",														rb_RPDB_TransactionSettingsController_turnEncloseAllActivityInTransactionOff,													0 	);
	rb_define_method(			rb_RPDB_TransactionSettingsController, 				"shm_key",														rb_RPDB_TransactionSettingsController_environmentalSnapshotIsolation,													0 	);
	rb_define_method(			rb_RPDB_TransactionSettingsController, 				"shm_key",														rb_RPDB_TransactionSettingsController_turnEnvironmentalSnapshotIsolationOn,													0 	);
	rb_define_method(			rb_RPDB_TransactionSettingsController, 				"shm_key",														rb_RPDB_TransactionSettingsController_turnEnvironmentalSnapshotIsolationOff,													0 	);
	rb_define_method(			rb_RPDB_TransactionSettingsController, 				"shm_key",														rb_RPDB_TransactionSettingsController_syncOnCommit,													0 	);
	rb_define_method(			rb_RPDB_TransactionSettingsController, 				"shm_key",														rb_RPDB_TransactionSettingsController_turnSyncOnCommitOn,													0 	);
	rb_define_method(			rb_RPDB_TransactionSettingsController, 				"shm_key",														rb_RPDB_TransactionSettingsController_turnSyncOnCommitOff,													0 	);
	rb_define_method(			rb_RPDB_TransactionSettingsController, 				"shm_key",														rb_RPDB_TransactionSettingsController_waitForLocks,													0 	);
	rb_define_method(			rb_RPDB_TransactionSettingsController, 				"shm_key",														rb_RPDB_TransactionSettingsController_turnWaitForLocksOn,													0 	);
	rb_define_method(			rb_RPDB_TransactionSettingsController, 				"shm_key",														rb_RPDB_TransactionSettingsController_turnWaitForLocksOff,													0 	);
	rb_define_method(			rb_RPDB_TransactionSettingsController, 				"shm_key",														rb_RPDB_TransactionSettingsController_maximumNumberOfTransactionsToRecover,													0 	);
	rb_define_method(			rb_RPDB_TransactionSettingsController, 				"shm_key",														rb_RPDB_TransactionSettingsController_setMaximumNumberOfTransactionsToRecover,													0 	);
	rb_define_method(			rb_RPDB_TransactionSettingsController, 				"shm_key",														rb_RPDB_TransactionSettingsController_timeoutInMicroseconds,													0 	);
	rb_define_method(			rb_RPDB_TransactionSettingsController, 				"shm_key",														rb_RPDB_TransactionSettingsController_setTimeoutInMicroseconds,													0 	);
	rb_define_method(			rb_RPDB_TransactionSettingsController, 				"shm_key",														rb_RPDB_TransactionSettingsController_maxOpen,													0 	);
	rb_define_method(			rb_RPDB_TransactionSettingsController, 				"shm_key",														rb_RPDB_TransactionSettingsController_setMaxOpen,													0 	);
	rb_define_method(			rb_RPDB_TransactionSettingsController, 				"shm_key",														rb_RPDB_TransactionSettingsController_recoveryTimestamp,													0 	);
	rb_define_method(			rb_RPDB_TransactionSettingsController, 				"shm_key",														rb_RPDB_TransactionSettingsController_setRecoveryTimestamp,													0 	);
