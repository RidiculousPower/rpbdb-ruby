...
VALUE rb_RPDB_EnvironmentCacheSettingsController_new(	VALUE	klass __attribute__ ((unused )),
	...
	VALUE	rb_environment_cache_settings_controller	= RUBY_RPDB_ENVIRONMENT_CACHE_SETTINGS_CONTROLLER( RPDB_EnvironmentCacheSettingsController_new( c_parent_settings_controller ) );
