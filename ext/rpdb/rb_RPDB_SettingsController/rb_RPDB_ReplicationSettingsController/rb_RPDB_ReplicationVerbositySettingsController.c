...
#include <rbdb/Rbdb_ReplicationVerbositySettingsController.h>
...
void Init_Rbdb_ReplicationVerbositySettingsController()	{
	...
	rb_define_singleton_method(	rb_Rbdb_ReplicationVerbositySettingsController, 	"new",																rb_Rbdb_ReplicationVerbositySettingsController_new,														-1 	);
	rb_define_method(			rb_Rbdb_ReplicationVerbositySettingsController, 				"initialize",													rb_Rbdb_ReplicationVerbositySettingsController_initialize,														-1 	);

	rb_define_method(			rb_Rbdb_ReplicationVerbositySettingsController, 				"parent_environment",									rb_Rbdb_ReplicationVerbositySettingsController_parentEnvironment,								0 	);
	rb_define_alias(			rb_Rbdb_ReplicationVerbositySettingsController, 				"environment",												"parent_environment"	);
	rb_define_method(			rb_Rbdb_ReplicationVerbositySettingsController,					"parent_settings_controller",					rb_Rbdb_ReplicationVerbositySettingsController_parentSettingsController,								0 	);
	rb_define_method(			rb_Rbdb_ReplicationVerbositySettingsController,					"parent_replication_settings_controller",					rb_Rbdb_ReplicationVerbositySettingsController_parentReplicationSettingsController,								0 	);

	rb_define_method(			rb_Rbdb_ReplicationVerbositySettingsController, 				"display_all_replication_information?",														rb_Rbdb_ReplicationVerbositySettingsController_displayAllReplicationInformation,													0 	);
	rb_define_method(			rb_Rbdb_ReplicationVerbositySettingsController, 				"turn_display_all_replication_information_on",														rb_Rbdb_ReplicationVerbositySettingsController_turnDisplayAllReplicationInformationOn,													0 	);
	rb_define_method(			rb_Rbdb_ReplicationVerbositySettingsController, 				"turn_display_all_replication_information_off",														rb_Rbdb_ReplicationVerbositySettingsController_turnDisplayAllReplicationInformationOff,													0 	);
	rb_define_method(			rb_Rbdb_ReplicationVerbositySettingsController, 				"display_election_information?",														rb_Rbdb_ReplicationVerbositySettingsController_displayElectionInformation,													0 	);
	rb_define_method(			rb_Rbdb_ReplicationVerbositySettingsController, 				"turn_display_election_information_on",														rb_Rbdb_ReplicationVerbositySettingsController_turnDisplayElectionInformationOn,													0 	);
	rb_define_method(			rb_Rbdb_ReplicationVerbositySettingsController, 				"turn_display_election_information_off",														rb_Rbdb_ReplicationVerbositySettingsController_turnDisplayElectionInformationOff,													0 	);
	rb_define_method(			rb_Rbdb_ReplicationVerbositySettingsController, 				"display_replication_master_lease_information?",														rb_Rbdb_ReplicationVerbositySettingsController_displayReplicationMasterLeaseInformation,													0 	);
	rb_define_method(			rb_Rbdb_ReplicationVerbositySettingsController, 				"turn_display_replication_master_lease_information_on",														rb_Rbdb_ReplicationVerbositySettingsController_turnDisplayReplicationMasterLeaseInformationOn,													0 	);
	rb_define_method(			rb_Rbdb_ReplicationVerbositySettingsController, 				"turn_display_replication_master_lease_information_off",														rb_Rbdb_ReplicationVerbositySettingsController_turnDisplayReplicationMasterLeaseInformationOff,													0 	);
	rb_define_method(			rb_Rbdb_ReplicationVerbositySettingsController, 				"display_misc_processing_information?",														rb_Rbdb_ReplicationVerbositySettingsController_displayMiscProcessingInformation,													0 	);
	rb_define_method(			rb_Rbdb_ReplicationVerbositySettingsController, 				"turn_display_misc_processing_information_on",														rb_Rbdb_ReplicationVerbositySettingsController_turnDisplayMiscProcessingInformationOn,													0 	);
	rb_define_method(			rb_Rbdb_ReplicationVerbositySettingsController, 				"turn_display_misc_processing_information_off",														rb_Rbdb_ReplicationVerbositySettingsController_turnDisplayMiscProcessingInformationOff,													0 	);
	rb_define_method(			rb_Rbdb_ReplicationVerbositySettingsController, 				"display_message_processing_information?",														rb_Rbdb_ReplicationVerbositySettingsController_displayMessageProcessingInformation,													0 	);
	rb_define_method(			rb_Rbdb_ReplicationVerbositySettingsController, 				"turn_display_message_processing_information_on",														rb_Rbdb_ReplicationVerbositySettingsController_turnDisplayMessageProcessingInformationOn,													0 	);
	rb_define_method(			rb_Rbdb_ReplicationVerbositySettingsController, 				"turn_display_message_processing_information_off",														rb_Rbdb_ReplicationVerbositySettingsController_turnDisplayMessageProcessingInformationOff,													0 	);
	rb_define_method(			rb_Rbdb_ReplicationVerbositySettingsController, 				"display_client_synchronization_information?",														rb_Rbdb_ReplicationVerbositySettingsController_displayClientSynchronizationInformation,													0 	);
	rb_define_method(			rb_Rbdb_ReplicationVerbositySettingsController, 				"turn_display_client_synchronization_information_on",														rb_Rbdb_ReplicationVerbositySettingsController_turnDisplayClientSynchronizationInformationOn,													0 	);
	rb_define_method(			rb_Rbdb_ReplicationVerbositySettingsController, 				"turn_display_client_synchronization_information_off",														rb_Rbdb_ReplicationVerbositySettingsController_turnDisplayClientSynchronizationInformationOff,													0 	);
	rb_define_method(			rb_Rbdb_ReplicationVerbositySettingsController, 				"display_manager_connection_failure_information?",														rb_Rbdb_ReplicationVerbositySettingsController_displayManagerConnectionFailureInformation,													0 	);
	rb_define_method(			rb_Rbdb_ReplicationVerbositySettingsController, 				"turn_display_manager_connection_failure_information_on",														rb_Rbdb_ReplicationVerbositySettingsController_turnDisplayManagerConnectionFailureInformationOn,													0 	);
	rb_define_method(			rb_Rbdb_ReplicationVerbositySettingsController, 				"turn_display_manager_connection_failure_information_off",														rb_Rbdb_ReplicationVerbositySettingsController_turnDisplayManagerConnectionFailureInformationOff,													0 	);
	rb_define_method(			rb_Rbdb_ReplicationVerbositySettingsController, 				"display_manager_misc_processing?",														rb_Rbdb_ReplicationVerbositySettingsController_displayManagerMiscProcessing,													0 	);
	rb_define_method(			rb_Rbdb_ReplicationVerbositySettingsController, 				"turn_display_manager_misc_processing_on",														rb_Rbdb_ReplicationVerbositySettingsController_turnDisplayManagerMiscProcessingOn,													0 	);
	rb_define_method(			rb_Rbdb_ReplicationVerbositySettingsController, 				"turn_display_manager_misc_processing_off",														rb_Rbdb_ReplicationVerbositySettingsController_turnDisplayManagerMiscProcessingOff,													0 	);
...
VALUE rb_Rbdb_ReplicationVerbositySettingsController_parentEnvironment(	VALUE	rb_replication_verbosity_settings_controller )	{
	...
	VALUE	rb_parent_settings_controller							=	rb_Rbdb_ReplicationVerbositySettingsController_parentSettingsController( rb_replication_verbosity_settings_controller );
...
VALUE rb_Rbdb_ReplicationVerbositySettingsController_parentSettingsController(	VALUE	rb_replication_verbosity_settings_controller )	{
	...
	VALUE	rb_parent_replication_settings_controller		=	rb_Rbdb_ReplicationVerbositySettingsController_parentReplicationSettingsController( rb_replication_verbosity_settings_controller );
