...
void Init_RPDB_DatabaseCursorReadWriteSettingsController()	{
	...
	rb_define_method(						rb_RPDB_DatabaseCursorReadWriteSettingsController, 	"parent_database_cursor",															rb_RPDB_DatabaseCursorReadWriteSettingsController_parentDatabaseCursor,													0 	);
	rb_define_alias(						rb_RPDB_DatabaseCursorReadWriteSettingsController, 	"parent_cursor",																			"parent_database_cursor"	);
...
VALUE rb_RPDB_DatabaseCursorReadWriteSettingsController_new(	int			argc,
	...
	if ( rb_parent_database_cursor != Qnil )	{
		rb_parent_database_cursor_settings_controller	=	rb_RPDB_DatabaseCursor_settingsController( rb_parent_database_cursor );
	}
...
VALUE rb_RPDB_DatabaseCursorReadWriteSettingsController_parentEnvironment(	VALUE	rb_database_cursor_read_write_settings_controller )	{
	...
	VALUE	rb_parent_database_settings_controller		=	rb_RPDB_DatabaseCursorReadWriteSettingsController_parentDatabaseSettingsController( rb_database_cursor_read_write_settings_controller );
...
VALUE rb_RPDB_DatabaseCursorReadWriteSettingsController_parentDatabaseCursor(	VALUE	rb_database_cursor_read_write_settings_controller )	{

	VALUE	rb_parent_database_cursor_settings_controller		=	rb_RPDB_DatabaseCursorReadWriteSettingsController_parentDatabaseCursorSettingsController( rb_database_cursor_read_write_settings_controller );
	VALUE	rb_parent_database_cursor												=	rb_RPDB_DatabaseCursorSettingsController_parentDatabaseCursor( rb_parent_database_cursor_settings_controller );
...
VALUE rb_RPDB_DatabaseCursorReadWriteSettingsController_parentSettingsController(	VALUE	rb_database_cursor_read_write_settings_controller )	{
...
VALUE rb_RPDB_DatabaseCursorReadWriteSettingsController_parentDatabaseSettingsController(	VALUE	rb_database_cursor_read_write_settings_controller )	{
...
VALUE rb_RPDB_DatabaseCursorReadWriteSettingsController_parentDatabaseCursorSettingsController(	VALUE	rb_database_cursor_read_write_settings_controller )	{
...
VALUE rb_RPDB_DatabaseCursorReadWriteSettingsController_permitWrite( VALUE	rb_database_cursor_read_write_settings_controller )	{
	...
	C_RPDB_DATABASE_CURSOR_READ_WRITE_SETTINGS_CONTROLLER( rb_database_cursor_read_write_settings_controller, c_database_cursor_record_read_write_settings_controller );
