...
VALUE rb_RPDB_DatabaseRecordFixedLengthSettingsController_new(	int			argc,
	...
	rb_iv_set(	rb_database_record_fixed_length_settings_controller,
							RPDB_RB_DATABASE_RECORD_FIXED_LENGTH_SETTINGS_CONTROLLER_VARIABLE_PARENT_DATABASE_RECORD_SETTINGS_CONTROLLER,
...
VALUE rb_RPDB_DatabaseRecordFixedLengthSettingsController_parentEnvironment(	VALUE	rb_database_record_fixed_length_settings_controller )	{
	...
	VALUE	rb_parent_database_settings_controller		=	rb_RPDB_DatabaseRecordFixedLengthSettingsController_parentDatabaseSettingsController( rb_database_record_fixed_length_settings_controller );
...
VALUE rb_RPDB_DatabaseRecordFixedLengthSettingsController_parentDatabaseSettingsController(	VALUE	rb_database_record_fixed_length_settings_controller )	{
	...
	VALUE	rb_parent_database_record_settings_controller		=	rb_RPDB_DatabaseRecordFixedLengthSettingsController_parentDatabaseRecordSettingsController( rb_database_record_fixed_length_settings_controller );
