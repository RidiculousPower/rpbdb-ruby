...
VALUE rb_RPDB_DatabaseRecordFixedLengthSettingsController_new(	VALUE	klass __attribute__ ((unused )),
	...
	RPDB_DatabaseRecordSettingsController*							c_database_record_settings_controller								=	RPDB_DatabaseSettingsController_recordSettingsController( c_parent_database_settings_controller );
