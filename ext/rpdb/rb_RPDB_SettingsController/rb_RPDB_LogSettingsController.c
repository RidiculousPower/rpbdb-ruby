...
void Init_RPDB_LogSettingsController()	{
	...
	rb_define_method(			rb_RPDB_LogSettingsController, 				"initialize",																	rb_RPDB_LogSettingsController_init,														1 	);
...
VALUE rb_RPDB_LogSettingsController_new(	VALUE	klass __attribute__ ((unused )),
...
VALUE rb_RPDB_LogSettingsController_init(	VALUE	rb_log_settings_controller,
