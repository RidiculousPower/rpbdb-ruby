...
VALUE	extern	rb_RPbdb_DebugSettingsController;
VALUE	extern	rb_RPbdb_DebugVerbositySettingsController;

void Init_rb_RPbdb_DebugSettingsController()	{

	rb_RPbdb_DebugSettingsController		=	rb_define_class_under(	rb_RPbdb_SettingsController, 
																															"Debug",	
																															rb_cObject );

	rb_define_singleton_method(	rb_RPbdb_DebugSettingsController, 	"new",																																	rb_RPbdb_DebugSettingsController_new,									-1 	);
	rb_define_method(						rb_RPbdb_DebugSettingsController, 	"initialize",																														rb_RPbdb_DebugSettingsController_initialize,									-1 	);
                    					                                                                                        				
	rb_define_method(						rb_RPbdb_DebugSettingsController, 	"parent_environment",																										rb_RPbdb_DebugSettingsController_parentEnvironment,						0 	);
	rb_define_alias(						rb_RPbdb_DebugSettingsController, 	"environment",																													"parent_environment"	);
	rb_define_method(						rb_RPbdb_DebugSettingsController, 	"parent_settings_controller",																						rb_RPbdb_DebugSettingsController_parentSettingsController,							0 	);
                    					                                                                                        				
	rb_define_method(						rb_RPbdb_DebugSettingsController, 	"run_normal_recovery_before_opening_environment?",											rb_RPbdb_DebugSettingsController_runNormalRecoveryBeforeOpeningEnvironment,									0 	);
	rb_define_method(						rb_RPbdb_DebugSettingsController, 	"turn_run_normal_recovery_before_opening_environment_on",								rb_RPbdb_DebugSettingsController_turnRunNormalRecoveryBeforeOpeningEnvironmentOn,								0 	);
	rb_define_method(						rb_RPbdb_DebugSettingsController, 	"turn_run_normal_recovery_before_opening_environment_off",							rb_RPbdb_DebugSettingsController_turnRunNormalRecoveryBeforeOpeningEnvironmentOff,				0 	);

	rb_define_method(						rb_RPbdb_DebugSettingsController, 	"run_catastrophic_recovery_before_opening_environment?",								rb_RPbdb_DebugSettingsController_runCatastrophicRecoveryBeforeOpeningEnvironment,		0 	);
	rb_define_method(						rb_RPbdb_DebugSettingsController, 	"turn_run_catastrophic_recovery_before_opening_environment_on",					rb_RPbdb_DebugSettingsController_turnRunCatastrophicRecoveryBeforeOpeningEnvironmentOn,		0 	);
	rb_define_method(						rb_RPbdb_DebugSettingsController, 	"turn_run_catastrophic_recovery_before_opening_environment_off",				rb_RPbdb_DebugSettingsController_turnRunCatastrophicRecoveryBeforeOpeningEnvironmentOff,					0 	);

	rb_define_method(						rb_RPbdb_DebugSettingsController, 	"open_in_lockdown?",																										rb_RPbdb_DebugSettingsController_openInLockdown,				0 	);
	rb_define_method(						rb_RPbdb_DebugSettingsController, 	"turn_open_in_lockdown_on",																							rb_RPbdb_DebugSettingsController_turnOpenInLockdownOn,				0 	);
	rb_define_method(						rb_RPbdb_DebugSettingsController, 	"turn_open_in_lockdown_off",																						rb_RPbdb_DebugSettingsController_turnOpenInLockdownOff,							0 	);

	rb_define_method(						rb_RPbdb_DebugSettingsController, 	"register_for_recovery?",																								rb_RPbdb_DebugSettingsController_registerForRecovery,					0 	);
	rb_define_method(						rb_RPbdb_DebugSettingsController, 	"turn_register_for_recovery_on",																				rb_RPbdb_DebugSettingsController_turnRegisterForRecoveryOn,					0 	);                    					                                                                                        									    		
	rb_define_method(						rb_RPbdb_DebugSettingsController, 	"turn_register_for_recovery_off",																				rb_RPbdb_DebugSettingsController_turnRegisterForRecoveryOff,							0 	);

	rb_define_method(						rb_RPbdb_DebugSettingsController, 	"prohibit_panic?",																												rb_RPbdb_DebugSettingsController_prohibitPanic,					0 	);
	rb_define_method(						rb_RPbdb_DebugSettingsController, 	"turn_prohibit_panic_on",																								rb_RPbdb_DebugSettingsController_turnProhibitPanicOn,					0 	);
	rb_define_method(						rb_RPbdb_DebugSettingsController, 	"turn_prohibit_panic_off",																							rb_RPbdb_DebugSettingsController_turnProhibitPanicOff,						0 	);

	rb_define_method(						rb_RPbdb_DebugSettingsController, 	"panic?",																																rb_RPbdb_DebugSettingsController_panic,					0 	);
	rb_define_method(						rb_RPbdb_DebugSettingsController, 	"turn_panic_on",																												rb_RPbdb_DebugSettingsController_turnPanicOn,					0 	);
	rb_define_method(						rb_RPbdb_DebugSettingsController, 	"turn_panic_off",																												rb_RPbdb_DebugSettingsController_turnPanicOff,					0 	);

	rb_define_method(						rb_RPbdb_DebugSettingsController, 	"yield_cpu_for_stress_test?",																						rb_RPbdb_DebugSettingsController_yieldCPUForStressTest,					0 	);
	rb_define_method(						rb_RPbdb_DebugSettingsController, 	"turn_yield_cpu_for_stress_test_on",																		rb_RPbdb_DebugSettingsController_turnYieldCPUForStressTestOn,					0 	);
	rb_define_method(						rb_RPbdb_DebugSettingsController, 	"turn_yield_cpu_for_stress_test_off",																		rb_RPbdb_DebugSettingsController_turnYieldCPUForStressTestOff,					0 	);

	rb_define_method(						rb_RPbdb_DebugSettingsController, 	"verbosity_settings_controller",																				rb_RPbdb_DebugSettingsController_verbositySettingsController,					0 	);
...
VALUE rb_RPbdb_DebugSettingsController_new(	int			argc,
	...
	RPbdb_DebugSettingsController*	c_debug_settings_controller	=	RPbdb_SettingsController_debugSettingsController( c_parent_settings_controller );
	
	VALUE	rb_debug_settings_controller	= RUBY_RPBDB_DEBUG_SETTINGS_CONTROLLER( c_debug_settings_controller );

	//	store reference to parent
	rb_iv_set(	rb_debug_settings_controller,
							RPBDB_RB_DEBUG_SETTINGS_CONTROLLER_VARIABLE_PARENT_SETTINGS_CONTROLLER,
...
VALUE rb_RPbdb_DebugSettingsController_parentEnvironment(	VALUE	rb_debug_settings_controller )	{
	...
	VALUE	rb_parent_settings_controller							=	rb_RPbdb_DebugSettingsController_parentSettingsController( rb_debug_settings_controller );
...
VALUE rb_RPbdb_DebugSettingsController_runNormalRecoveryBeforeOpeningEnvironment( VALUE	rb_debug_settings_controller )	{
	...
	RPbdb_DebugSettingsController*	c_debug_settings_controller;
	C_RPBDB_DEBUG_SETTINGS_CONTROLLER( rb_debug_settings_controller, c_debug_settings_controller );

	return ( RPbdb_DebugSettingsController_runNormalRecoveryBeforeOpeningEnvironment( c_debug_settings_controller )	?	Qtrue
																																																									:	Qfalse );
}
	...
	***********************************************************/
	...
	VALUE rb_RPbdb_DebugSettingsController_turnRunNormalRecoveryBeforeOpeningEnvironmentOn( VALUE	rb_debug_settings_controller )	{
		...
		RPbdb_DebugSettingsController_turnRunNormalRecoveryBeforeOpeningEnvironmentOn( c_debug_settings_controller );
	...
	************************************************************/
	...
	VALUE rb_RPbdb_DebugSettingsController_turnRunNormalRecoveryBeforeOpeningEnvironmentOff( VALUE	rb_debug_settings_controller )	{
		...
		RPbdb_DebugSettingsController_turnRunNormalRecoveryBeforeOpeningEnvironmentOff( c_debug_settings_controller );
...
VALUE rb_RPbdb_DebugSettingsController_runCatastrophicRecoveryBeforeOpeningEnvironment( VALUE	rb_debug_settings_controller )	{
	...
	return ( RPbdb_DebugSettingsController_runCatastrophicRecoveryBeforeOpeningEnvironment( c_debug_settings_controller )	?	Qtrue
																															:	Qfalse );
}
	...
	*****************************************************************/
	...
	VALUE rb_RPbdb_DebugSettingsController_turnRunCatastrophicRecoveryBeforeOpeningEnvironmentOn( VALUE	rb_debug_settings_controller )	{
		...
		RPbdb_DebugSettingsController_turnRunCatastrophicRecoveryBeforeOpeningEnvironmentOn( c_debug_settings_controller );
	...
	******************************************************************/
	...
	VALUE rb_RPbdb_DebugSettingsController_turnRunCatastrophicRecoveryBeforeOpeningEnvironmentOff( VALUE	rb_debug_settings_controller )	{
		...
		RPbdb_DebugSettingsController_turnRunCatastrophicRecoveryBeforeOpeningEnvironmentOff( c_debug_settings_controller );
...
VALUE rb_RPbdb_DebugSettingsController_openInLockdown( VALUE	rb_debug_settings_controller )	{
	...
	return ( RPbdb_DebugSettingsController_openInLockdown( c_debug_settings_controller )	?	Qtrue
																							:	Qfalse );
}
	...
	*****************************/
	...
	VALUE rb_RPbdb_DebugSettingsController_turnOpenInLockdownOn( VALUE	rb_debug_settings_controller )	{
		...
		RPbdb_DebugSettingsController_turnOpenInLockdownOn( c_debug_settings_controller );
	...
	******************************/
	...
	VALUE rb_RPbdb_DebugSettingsController_turnOpenInLockdownOff( VALUE	rb_debug_settings_controller )	{
		...
		RPbdb_DebugSettingsController_turnOpenInLockdownOff( c_debug_settings_controller );
...
VALUE rb_RPbdb_DebugSettingsController_registerForRecovery( VALUE	rb_debug_settings_controller )	{
	...
	return ( RPbdb_DebugSettingsController_registerForRecovery( c_debug_settings_controller )	?	Qtrue
																													:	Qfalse );
}
	...
	**********************************************************/
	...
	VALUE rb_RPbdb_DebugSettingsController_turnRegisterForRecoveryOn( VALUE	rb_debug_settings_controller )	{
		...
		RPbdb_DebugSettingsController_turnRegisterForRecoveryOn( c_debug_settings_controller );
	...
	***********************************************************/
	...
	VALUE rb_RPbdb_DebugSettingsController_turnRegisterForRecoveryOff( VALUE	rb_debug_settings_controller )	{
		...
		RPbdb_DebugSettingsController_turnRegisterForRecoveryOff( c_debug_settings_controller );
...
VALUE rb_RPbdb_DebugSettingsController_prohibitPanic( VALUE	rb_debug_settings_controller )	{
	...
	return ( RPbdb_DebugSettingsController_prohibitPanic( c_debug_settings_controller )	?	Qtrue
																						:	Qfalse );
}
	...
	***************************/
	...
	VALUE rb_RPbdb_DebugSettingsController_turnProhibitPanicOn( VALUE	rb_debug_settings_controller )	{
		...
		RPbdb_DebugSettingsController_turnProhibitPanicOn( c_debug_settings_controller );
	...
	****************************/
	...
	VALUE rb_RPbdb_DebugSettingsController_turnProhibitPanicOff( VALUE	rb_debug_settings_controller )	{
		...
		RPbdb_DebugSettingsController_turnProhibitPanicOff( c_debug_settings_controller );
...
VALUE rb_RPbdb_DebugSettingsController_panic( VALUE	rb_debug_settings_controller )	{
	...
	return ( RPbdb_DebugSettingsController_panic( c_debug_settings_controller )	?	Qtrue
																				:	Qfalse );
}
	...
	******************/
	...
	VALUE rb_RPbdb_DebugSettingsController_turnPanicOn( VALUE	rb_debug_settings_controller )	{
		...
		RPbdb_DebugSettingsController_turnPanicOn( c_debug_settings_controller );
	...
	*******************/
	...
	VALUE rb_RPbdb_DebugSettingsController_turnPanicOff( VALUE	rb_debug_settings_controller )	{
		...
		RPbdb_DebugSettingsController_turnPanicOff( c_debug_settings_controller );
...
VALUE rb_RPbdb_DebugSettingsController_yieldCPUForStressTest( VALUE	rb_debug_settings_controller )	{
	...
	return ( RPbdb_DebugSettingsController_yieldCPUForStressTest( c_debug_settings_controller )	?	Qtrue
																								:	Qfalse );
}
	...
	**************************************/
	...
	VALUE rb_RPbdb_DebugSettingsController_turnYieldCPUForStressTestOn( VALUE	rb_debug_settings_controller )	{
		...
		RPbdb_DebugSettingsController_turnYieldCPUForStressTestOn( c_debug_settings_controller );
	...
	***************************************/
	...
	VALUE rb_RPbdb_DebugSettingsController_turnYieldCPUForStressTestOff( VALUE	rb_debug_settings_controller )	{
		...
		RPbdb_DebugSettingsController_turnYieldCPUForStressTestOff( c_debug_settings_controller );
...
VALUE rb_RPbdb_DebugSettingsController_verbositySettingsController( VALUE	rb_debug_settings_controller )	{
	...
	if ( ( rb_debug_verbosity_settings_controller = rb_iv_get(	rb_debug_settings_controller,
																															RPBDB_RB_SETTINGS_VARIABLE_DEBUG_VERBOSITY_SETTINGS_CONTROLLER ) == Qnil ) )	{
	
		rb_debug_verbosity_settings_controller	=	rb_RPbdb_DebugVerbositySettingsController_new(	1,
																																														& rb_debug_settings_controller,
																																														rb_RPbdb_DebugVerbositySettingsController );
		rb_iv_set(	rb_debug_settings_controller,
								RPBDB_RB_SETTINGS_VARIABLE_DEBUG_VERBOSITY_SETTINGS_CONTROLLER,
