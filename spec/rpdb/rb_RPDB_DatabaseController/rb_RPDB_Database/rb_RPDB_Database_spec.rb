...
#    RPDB::Environment::DatabaseController::Database.new( $database_name, @environment ).should_not == nil
  ...
  it "can be created with a name and a parent environment name" do
#    RPDB::Environment::DatabaseController::Database.new( $database_name, $environment_name ).should_not == nil  
  end
  ...
  it "can be created with a name and a parent database controller" do
    # make sure we aren't testing nil
...
#    @environment.database.new( $database_name ).name.should == $database_name.to_s
  end
  ...
  it "can report its handle" do
#    @environment.database.new( $database_name ).handle.should == $database_name
  end
