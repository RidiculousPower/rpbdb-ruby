...
describe RPbdb::Database::Sequence do
  ...
  # RPbdb::Database::Sequence.new( database_sequence_controller )
  it "can be created with a name, a parent database sequence controller" do
    RPbdb::Database::Sequence.new( $sequence_name, @database.sequence_controller ).should_not == nil
  end

  # RPbdb::Database::Sequence.new( database )
  it "can be created with a name and a parent database" do
    RPbdb::Database::Sequence.new( $sequence_name, @database ).should_not == nil
  end

  # RPbdb::Database::Sequence.new( database )
  it "can be created with a name and a database name" do
    RPbdb::Database::Sequence.new( $sequence_name, @database.name ).should_not == nil
  end

  # RPbdb::Database::Sequence.new( environment, database_name ) 
  it "can be created with a name, a database controller and a database name" do
    RPbdb::Database::Sequence.new( $sequence_name, @database_controller, @database.name ).should_not == nil  
  end

  # RPbdb::Database::Sequence.new( environment, database_name ) 
  it "can be created with a name, a parent environment and a database name" do
    RPbdb::Database::Sequence.new( $sequence_name, @environment, @database.name ).should_not == nil  
  end

  # RPbdb::Database::Sequence.new( environment_directory, database_name ) 
  it "can be created with a name, a parent environment home directory and a database name" do
    RPbdb::Database::Sequence.new( $sequence_name, $environment_path, @database.name ).should_not == nil  
  end
