...
describe RPbdb::Settings::Thread do
  ...
  # RPbdb::Settings::Thread.new( environment )
  it "can be created with an environment" do
    @environment.open
    RPbdb::Settings::Thread.new( @environment ).should_not == nil
  end

  # RPbdb::Settings::Thread.new( settings_controller )
  it "can be created with a settings controller" do
    @environment.open
    RPbdb::Settings::Thread.new( RPbdb::Settings.new ).should_not == nil
  end

  # RPbdb::Settings::Thread.new
  it "can be created with no argument specified" do
    @environment.open
    RPbdb::Settings::Thread.new.should_not == nil
  end
  ...
  it "can return its parent environment" do
    @environment.open
    RPbdb::Settings::Thread.new.parent_environment.should_not == nil
  end
  ...
  it "can return its parent settings controller" do
    @environment.open
    RPbdb::Settings::Thread.new.parent_settings_controller.should_not == nil
  end
  ...
  it "can be turned on or off as well as report whether it is on or off" do
    thread_settings  = RPbdb::Settings::Thread.new( @environment )
