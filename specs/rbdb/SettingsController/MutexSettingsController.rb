...
describe RPbdb::Settings::Mutex do
  ...
  # RPbdb::Settings::Mutex.new( environment )
  it "can be created with an environment" do
    @environment.open
    RPbdb::Settings::Mutex.new( @environment ).should_not == nil
  end

  # RPbdb::Settings::Mutex.new( settings_controller )
  it "can be created with a settings controller" do
    @environment.open
    RPbdb::Settings::Mutex.new( RPbdb::Settings.new ).should_not == nil
  end

  # RPbdb::Settings::Mutex.new
  it "can be created with no argument specified" do
    @environment.open
    RPbdb::Settings::Mutex.new.should_not == nil
  end
  ...
  it "can return its parent environment" do
    @environment.open
    RPbdb::Settings::Mutex.new.parent_environment.should_not == nil
  end
  ...
  it "can return its parent settings controller" do
    @environment.open
    RPbdb::Settings::Mutex.new.parent_settings_controller.should_not == nil
  end
  ...
  it "can set and return its blcoking time for test and spin mutexes" do
    @environment.open
    mutex_settings  = RPbdb::Settings::Mutex.new
  ...
  it "can set its maximum allowable mutex limit" do
    mutex_settings  = RPbdb::Settings::Mutex.new( @environment )
