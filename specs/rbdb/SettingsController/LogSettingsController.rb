...
describe RPbdb::Settings::Log do
  ...
  # RPbdb::Settings::Log.new( environment )
  it "can be created with an environment" do
    @environment.open
    RPbdb::Settings::Log.new( @environment ).should_not == nil
  end

  # RPbdb::Settings::Log.new( settings_controller )
  it "can be created with a settings controller" do
    @environment.open
    RPbdb::Settings::Log.new( RPbdb::Settings.new ).should_not == nil
  end

  # RPbdb::Settings::Log.new
  it "can be created with no argument specified" do
    @environment.open
    RPbdb::Settings::Log.new.should_not == nil
  end
  ...
  it "can return its parent environment" do
    @environment.open
    RPbdb::Settings::Log.new.parent_environment.should_not == nil
  end
  ...
  it "can return its parent settings controller" do
    @environment.open
    RPbdb::Settings::Log.new.parent_settings_controller.should_not == nil
  end
  ...
  it "can turn on and off and report whether it is on or off" do
    @environment.open
    log_settings  = RPbdb::Settings::Log.new
  ...
  it "can turn system buffering on and off" do
    ...
    log_settings  = RPbdb::Settings::Log.new( @environment )
