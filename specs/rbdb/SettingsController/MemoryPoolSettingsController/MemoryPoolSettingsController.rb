...
describe RPbdb::Settings::MemoryPool do
  ...
  # RPbdb::Settings::MemoryPool.new( environment )
  it "can be created with an environment" do
    RPbdb::Settings::MemoryPool.new( @environment ).should_not == nil
  end

  # RPbdb::Settings::MemoryPool.new( settings_controller )
  it "can be created with a settings controller" do
    RPbdb::Settings::MemoryPool.new( RPbdb::Settings.new ).should_not == nil
  end

  # RPbdb::Settings::MemoryPool.new
  it "can be created with no argument specified" do
    RPbdb::Settings::MemoryPool.new.should_not == nil
  end
  ...
  it "can return its parent environment" do
    RPbdb::Settings::MemoryPool.new.parent_environment.should_not == nil
  end
  ...
  it "can return its parent settings controller" do
    RPbdb::Settings::MemoryPool.new.parent_settings_controller.should_not == nil
  end
  ...
  it "it can turn on and off and report whether it is on or off" do
    memory_pool_settings  = RPbdb::Settings::MemoryPool.new
  ...
  it "can return its file settings controller" do
    RPbdb::Settings::MemoryPool.new.file_settings_controller.is_a?( RPbdb::Settings::MemoryPool::File ).should == true
  end
  ...
  it "can return its read/write settings controller" do
    RPbdb::Settings::MemoryPool.new.read_write_settings_controller.is_a?( RPbdb::Settings::MemoryPool::ReadWrite ).should == true
  end
