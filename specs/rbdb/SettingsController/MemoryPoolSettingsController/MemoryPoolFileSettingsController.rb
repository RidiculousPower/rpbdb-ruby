...
describe RPbdb::Settings::MemoryPool::File do
  ...
  # RPbdb::Settings::MemoryPool::File.new( environment )
  it "can be created with an environment" do
    RPbdb::Settings::MemoryPool::File.new( @environment ).should_not == nil
  end

  # RPbdb::Settings::MemoryPool::File.new( settings_controller )
  it "can be created with a settings controller" do
    RPbdb::Settings::MemoryPool::File.new( RPbdb::Settings.new ).should_not == nil
  end

  # RPbdb::Settings::MemoryPool::File.new( memory_pool_settings_controller )
  it "can be created with a memory pool settings controller" do
    RPbdb::Settings::MemoryPool::File.new( RPbdb::Settings::MemoryPool.new ).should_not == nil
  end

  # RPbdb::Settings::MemoryPool::File.new
  it "can be created with no argument specified" do
    RPbdb::Settings::MemoryPool::File.new.should_not == nil
  end
  ...
  it "can return its parent environment" do
    RPbdb::Settings::MemoryPool::File.new.parent_environment.should_not == nil
  end
  ...
  it "can return its parent settings controller" do
    RPbdb::Settings::MemoryPool::File.new.parent_settings_controller.should_not == nil
  end
  ...
  it "can return its parent memory pool settings controller" do
    RPbdb::Settings::MemoryPool::File.new.parent_memory_pool_settings_controller.should_not == nil
  end
  ...
  it "can set its cache size according to various measures" do
    memory_pool_file_settings = RPbdb::Settings::MemoryPool::File.new( @environment )
...
#    memory_pool_file_settings.max_size_in_bytes.should == 42 * 1024 + 12
  ...
  it "can be set to create file with initial null bytes numbering ______" do
    memory_pool_file_settings = RPbdb::Settings::MemoryPool::File.new
  ...
  it "can return its cache settings controller" do
    RPbdb::Settings::MemoryPool::File.new.cache_settings_controller.is_a?( RPbdb::Settings::MemoryPool::File::Cache ).should == true
  end
  ...
  it "can return its page settings controller" do
    RPbdb::Settings::MemoryPool::File.new.page_settings_controller.is_a?( RPbdb::Settings::MemoryPool::File::Page ).should == true
  end
