...
describe RPbdb::Settings::Replication::Verbosity do
  ...
  # RPbdb::Settings::Replication::Verbosity.new( environment )
  it "can be created with an environment" do
    RPbdb::Settings::Replication::Verbosity.new( @environment ).should_not == nil
  end

  # RPbdb::Settings::Replication::Verbosity.new( settings_controller )
  it "can be created with a settings controller" do
    RPbdb::Settings::Replication::Verbosity.new( RPbdb::Settings.new ).should_not == nil
  end

  # RPbdb::Settings::Replication::Verbosity.new( replication_settings_controller )
  it "can be created with a replication settings controller" do
    RPbdb::Settings::Replication::Verbosity.new( RPbdb::Settings::Replication.new ).should_not == nil
  end

  # RPbdb::Settings::Replication::Verbosity.new
  it "can be created with no argument specified" do
    RPbdb::Settings::Replication::Verbosity.new.should_not == nil
  end
  ...
  it "can return its parent environment" do
    RPbdb::Settings::Replication::Verbosity.new.parent_environment.should_not == nil
  end
  ...
  it "can return its parent settings controller" do
    RPbdb::Settings::Replication::Verbosity.new.parent_settings_controller.should_not == nil
  end
  ...
  it "can return its parent replication settings controller" do
    RPbdb::Settings::Replication::Verbosity.new.parent_replication_settings_controller.should_not == nil
  end
  ...
  it "can be set to display all replication information" do
    verbosity_settings  = RPbdb::Settings::Replication::Verbosity.new
