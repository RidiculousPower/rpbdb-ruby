...
describe RPbdb::Settings::Replication do
  ...
  # RPbdb::Settings::Replication.new( environment )
  it "can be created with an environment" do
    @environment.open
    RPbdb::Settings::Replication.new( @environment ).should_not == nil
  end

  # RPbdb::Settings::Replication.new( settings_controller )
  it "can be created with a settings controller" do
    @environment.open
    RPbdb::Settings::Replication.new( RPbdb::Settings.new ).should_not == nil
  end

  # RPbdb::Settings::Replication.new
  it "can be created with no argument specified" do
    @environment.open
    RPbdb::Settings::Replication.new.should_not == nil
  end
  ...
  it "can return its parent environment" do
    @environment.open
    RPbdb::Settings::Replication.new.parent_environment.should_not == nil
  end
  ...
  it "can return its parent settings controller" do
    @environment.open
    RPbdb::Settings::Replication.new.parent_settings_controller.should_not == nil
  end
  ...
  it "can be turned on or off and report whether it is on or off" do
    replication_settings  = RPbdb::Settings::Replication.new( @environment )
  ...
  it "can set its host" do
    @environment.open
    replication_settings  = RPbdb::Settings::Replication.new
  ...
  it "can return its election settings controller" do
    @environment.open
    RPbdb::Settings::Replication.new.election_settings_controller.is_a?( RPbdb::Settings::Replication::Election ).should == true
  end
  ...
  it "can return its timeout settings controller" do
    @environment.open
    RPbdb::Settings::Replication.new.timeout_settings_controller.is_a?( RPbdb::Settings::Replication::Timeout ).should == true
  end
