...
describe RPbdb::Settings::Replication::Election do
  ...
  # RPbdb::Settings::Replication::Election.new( environment )
  it "can be created with an environment" do
    RPbdb::Settings::Replication::Election.new( @environment ).should_not == nil
  end

  # RPbdb::Settings::Replication::Election.new( settings_controller )
  it "can be created with a settings controller" do
    @environment.open
    RPbdb::Settings::Replication::Election.new( RPbdb::Settings.new ).should_not == nil
  end

  # RPbdb::Settings::Replication::Election.new( election_settings_controller )
  it "can be created with a replication settings controller" do
    @environment.open
    RPbdb::Settings::Replication::Election.new( RPbdb::Settings::Replication.new ).should_not == nil
  end

  # RPbdb::Settings::Replication::Election.new
  it "can be created with no argument specified" do
    @environment.open
    RPbdb::Settings::Replication::Election.new.should_not == nil
  end
  ...
  it "can return its parent environment" do
    @environment.open
    RPbdb::Settings::Replication::Election.new.parent_environment.should_not == nil
  end
  ...
  it "can return its parent settings controller" do
    @environment.open
    RPbdb::Settings::Replication::Election.new.parent_settings_controller.should_not == nil
  end
  ...
  it "can return its parent replication settings controller" do
    @environment.open
    RPbdb::Settings::Replication::Election.new.parent_replication_settings_controller.should_not == nil
  end
  ...
  it "can be set to wait for all clients to respond to election" do
    election_settings  = RPbdb::Settings::Replication::Election.new( @environment )
  ...
  it "can set and return the number of sites required for election" do
    @environment.open
    election_settings  = RPbdb::Settings::Replication::Election.new
