...
describe RPbdb::Settings::Database::Cache::Priority do
  ...
  # RPbdb::Settings::Database::Cache::Priority.new( environment )
  it "can be created with an environment" do
    RPbdb::Settings::Database::Cache::Priority.new( @environment ).is_a?( RPbdb::Settings::Database::Cache::Priority ).should == true
  end

  # RPbdb::Settings::Database::Cache::Priority.new( database_controller )
  it "can be created with a database controller" do
    RPbdb::Settings::Database::Cache::Priority.new( @environment.database_controller ).is_a?( RPbdb::Settings::Database::Cache::Priority ).should == true
  end

  # RPbdb::Settings::Database::Cache::Priority.new( database )
  it "can be created with a database" do
    RPbdb::Settings::Database::Cache::Priority.new( RPbdb::Database.new( $database_name ) ).is_a?( RPbdb::Settings::Database::Cache::Priority ).should == true
  end

  # RPbdb::Settings::Database::Cache::Priority.new( settings_controller )
  it "can be created with a settings controller" do
    RPbdb::Settings::Database::Cache::Priority.new( RPbdb::Settings.new ).is_a?( RPbdb::Settings::Database::Cache::Priority ).should == true
  end

  # RPbdb::Settings::Database::Cache::Priority.new( database_settings_controller )
  it "can be created with a database settings controller" do
    RPbdb::Settings::Database::Cache::Priority.new( RPbdb::Settings::Database.new ).is_a?( RPbdb::Settings::Database::Cache::Priority ).should == true
  end

  # RPbdb::Settings::Database::Cache::Priority.new
  it "can be created with no argument specified" do
    RPbdb::Settings::Database::Cache::Priority.new.is_a?( RPbdb::Settings::Database::Cache::Priority ).should == true
  end
  ...
  it "can return its parent environment" do
    RPbdb::Settings::Database::Cache::Priority.new.parent_environment..is_a?( RPbdb::Environment ).should == true
  end
  ...
  it "can return its parent database" do
    RPbdb::Settings::Database::Cache::Priority.new( RPbdb::Database.new( $database_name ) ).parent_database.is_a?( RPbdb::Database ).should == true
  end
  ...
  it "can return its parent settings controller" do
    RPbdb::Settings::Database::Cache::Priority.new.parent_settings_controller.is_a?( RPbdb::Settings ).should == true
  end
  ...
  it "can return its parent database settings controller" do
    RPbdb::Settings::Database::Cache::Priority.new.parent_database_settings_controller.is_a?( RPbdb::Settings::Database ).should == true
  end
  ...
  it "can return its parent database cache settings controller" do
    RPbdb::Settings::Database::Cache::Priority.new.parent_database_cache_settings_controller.is_a?( RPbdb::Settings::Database::Cache ).should == true
  end
  ...
  it "can set priority and report whether a priority level is currently set as well as report its current priority" do
    priority_settings_controller  = RPbdb::Settings::Database::Cache::Priority.new
