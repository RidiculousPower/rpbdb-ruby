...
describe RPbdb::Settings::Lock do
  ...
  # RPbdb::Settings::Lock.new( environment )
  it "can be created with an environment" do
    @environment.open
    RPbdb::Settings::Lock.new( @environment ).should_not == nil
  end

  # RPbdb::Settings::Lock.new( settings_controller )
  it "can be created with a settings controller" do
    @environment.open
    RPbdb::Settings::Lock.new( RPbdb::Settings.new ).should_not == nil
  end

  # RPbdb::Settings::Lock.new
  it "can be created with no argument specified" do
    @environment.open
    RPbdb::Settings::Lock.new.should_not == nil
  end
  ...
  it "can return its parent environment" do
    @environment.open
    RPbdb::Settings::Lock.new.parent_environment.should_not == nil
  end
  ...
  it "can return its parent settings controller" do
    @environment.open
    RPbdb::Settings::Lock.new.parent_settings_controller.should_not == nil
  end
  ...
  it "can be turned on and off and report whether it is on or off" do
    @environment.open
    lock_settings  = RPbdb::Settings::Lock.new
  ...
  it "can set and return its maximum locker limit" do
    lock_settings  = RPbdb::Settings::Lock.new( @environment )
  ...
  it "can return its deadlock detector settings controller" do
    @environment.open
    RPbdb::Settings::Lock.new.deadlock_detector_settings_controller.is_a?( RPbdb::Settings::Lock::DeadlockDetector ).should == true
  end
