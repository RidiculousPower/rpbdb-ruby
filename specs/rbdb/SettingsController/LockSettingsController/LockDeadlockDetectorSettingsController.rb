...
describe RPbdb::Settings::Lock::DeadlockDetector do
  ...
  # RPbdb::Settings::Lock::DeadlockDetector.new( environment )
  it "can be created with an environment" do
    RPbdb::Settings::Lock::DeadlockDetector.new( @environment ).should_not == nil
  end

  # RPbdb::Settings::Lock::DeadlockDetector.new( settings_controller )
  it "can be created with a settings controller" do
    RPbdb::Settings::Lock::DeadlockDetector.new( RPbdb::Settings.new ).should_not == nil
  end

  # RPbdb::Settings::Lock::DeadlockDetector.new( lock_settings_controller )
  it "can be created with a lock settings controller" do
    RPbdb::Settings::Lock::DeadlockDetector.new( RPbdb::Settings::Lock.new ).should_not == nil
  end

  # RPbdb::Settings::Lock::DeadlockDetector.new
  it "can be created with no argument specified" do
    RPbdb::Settings::Lock::DeadlockDetector.new.should_not == nil
  end
  ...
  it "can return its parent environment" do
    RPbdb::Settings::Lock::DeadlockDetector.new.parent_environment.should_not == nil
  end
  ...
  it "can return its parent settings controller" do
    RPbdb::Settings::Lock::DeadlockDetector.new.parent_settings_controller.should_not == nil
  end
  ...
  it "can return its parent lock settings controller" do
    RPbdb::Settings::Lock::DeadlockDetector.new.parent_lock_settings_controller.should_not == nil
  end
  ...
  it "can be set to default settings and report whether it is currently set to default" do
    raise "Lock priority"
    deadlock_detector_settings  = RPbdb::Settings::Lock::DeadlockDetector.new
  ...
  it "can return its verbosity settings controller" do
    RPbdb::Settings::Lock::DeadlockDetector.new.verbosity_settings_controller.is_a?( RPbdb::Settings::Lock::DeadlockDetector::Verbosity ).should == true
  end
