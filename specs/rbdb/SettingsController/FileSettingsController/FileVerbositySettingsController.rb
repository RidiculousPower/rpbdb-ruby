...
describe RPbdb::Database do
  ...
  # RPbdb::Settings::File::Verbosity.new( environment )
  it "can be created with an environment" do
    RPbdb::Settings::File::Verbosity.new( @environment ).should_not == nil
  end

  # RPbdb::Settings::File::Verbosity.new( settings_controller )
  it "can be created with a settings controller" do
    RPbdb::Settings::File::Verbosity.new( RPbdb::Settings.new ).should_not == nil
  end

  # RPbdb::Settings::File::Verbosity.new( settings_controller )
  it "can be created with a file settings controller" do
    RPbdb::Settings::File::Verbosity.new( RPbdb::Settings::File.new ).should_not == nil
  end

  # RPbdb::Settings::File::Verbosity.new
  it "can be created with no environment specified" do
    RPbdb::Settings::File::Verbosity.new.should_not == nil
  end
  ...
  it "can return its parent environment" do
    RPbdb::Settings::File::Verbosity.new.parent_environment.should_not == nil
  end
  ...
  it "can return its parent settings controller" do
    RPbdb::Settings::File::Verbosity.new.parent_settings_controller.should_not == nil
  end
  ...
  it "can return its parent file settings controller" do
    RPbdb::Settings::File::Verbosity.new.parent_file_settings_controller.should_not == nil
  end
  ...
  it "can be set to display additional information during open/close/rename file operations" do
    verbosity_settings  = RPbdb::Settings::File::Verbosity.new
