...
describe RPbdb::Settings do
  ...
  # RPbdb::Settings.new( environment )
  it "can be created with an environment" do
    environment = RPbdb::Environment.new( $environment_path ).open
    RPbdb::Settings.new( environment ).should_not == nil
    environment.close
  end
  ...
  it "can be created with no argument specified" do
    environment = RPbdb::Environment.new( $environment_path ).open
    RPbdb::Settings.new.should_not == nil
    environment.close
  end
  ...
  it "can return its parent environment" do
    environment = RPbdb::Environment.new( $environment_path ).open
    RPbdb::Settings.new.parent_environment.should_not == nil
    environment.close
  end
  ...
  it "can return its file settings controller" do
    RPbdb::Environment.new( $environment_path ).settings.file_settings_controller.should_not == nil
  end
  ...
  it "can return its error settings controller" do
    RPbdb::Environment.new( $environment_path ).settings.error_settings_controller.should_not == nil
  end
  ...
  it "can return its log settings controller" do
    RPbdb::Environment.new( $environment_path ).settings.log_settings_controller.should_not == nil
  end
  ...
  it "can return its lock settings controller" do
    RPbdb::Environment.new( $environment_path ).settings.lock_settings_controller.should_not == nil
  end
  ...
  it "can return its replication settings controller" do
    RPbdb::Environment.new( $environment_path ).settings.replication_settings_controller.should_not == nil
  end
  ...
  it "can return its memory pool settings controller" do
    RPbdb::Environment.new( $environment_path ).settings.memory_pool_settings_controller.should_not == nil
  end
  ...
  it "can return its database settings controller" do
    RPbdb::Environment.new( $environment_path ).settings.database_settings_controller.should_not == nil
  end
  ...
  it "can return its directory settings controller" do
    RPbdb::Environment.new( $environment_path ).settings.directory_settings_controller.should_not == nil
  end
