...
describe Rbdb::Database do
  ...
  # Rbdb::Settings::File.new( environment )
  it "can be created with an environment" do
    @environment.open
    Rbdb::Settings::File.new( @environment ).should_not == nil
  end

  # Rbdb::Settings::File.new( settings_controller )
  it "can be created with a settings controller" do
    @environment.open
    Rbdb::Settings::File.new( Rbdb::Settings.new ).should_not == nil
  end

  # Rbdb::Settings::File.new
  it "can be created with no environment specified" do
    @environment.open
    Rbdb::Settings::File.new.should_not == nil
  end
  ...
  it "can return its parent environment" do
    @environment.open
    Rbdb::Settings::File.new.parent_environment.should_not == nil
  end
  ...
  it "can return its parent settings controller" do
    @environment.open
    Rbdb::Settings::File.new.parent_settings_controller.should_not == nil
  end
  ...
  it "can be set to create intermediate directories needed for recovery (9 character unix-style permissions)" do
    file_settings = Rbdb::Settings::File.new( @environment )
  ...
  it "can specify its temp directory" do
    @environment.open
    file_settings = Rbdb::Settings::File.new
  ...
  it "can return its verbosity settings controller" do
    @environment.open
    Rbdb::Settings::File.new.verbosity_settings_controller.is_a?( Rbdb::Settings::File::Verbosity ).should == true
  end
