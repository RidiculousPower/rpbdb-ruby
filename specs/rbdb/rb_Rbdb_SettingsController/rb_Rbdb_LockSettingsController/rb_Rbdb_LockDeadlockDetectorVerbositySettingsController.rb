...
describe Rbdb::Settings::Lock::DeadlockDetector::Verbosity do
  ...
  # Rbdb::Settings::Lock::DeadlockDetector::Verbosity.new( environment )
  it "can be created with an environment" do
    Rbdb::Settings::Lock::DeadlockDetector::Verbosity.new( @environment ).should_not == nil
  end

  # Rbdb::Settings::Lock::DeadlockDetector::Verbosity.new( settings_controller )
  it "can be created with a settings controller" do
    Rbdb::Settings::Lock::DeadlockDetector::Verbosity.new( Rbdb::Settings.new ).should_not == nil
  end

  # Rbdb::Settings::Lock::DeadlockDetector::Verbosity.new( lock_settings_controller )
  it "can be created with a lock settings controller" do
    Rbdb::Settings::Lock::DeadlockDetector::Verbosity.new( Rbdb::Settings::Lock.new ).should_not == nil
  end

  # Rbdb::Settings::Lock::DeadlockDetector::Verbosity.new( lock_settings_controller )
  it "can be created with a lock deadlock detector settings controller" do
    Rbdb::Settings::Lock::DeadlockDetector::Verbosity.new( Rbdb::Settings::Lock::DeadlockDetector.new ).should_not == nil
  end

  # Rbdb::Settings::Lock::DeadlockDetector::Verbosity.new
  it "can be created with no argument specified" do
    Rbdb::Settings::Lock::DeadlockDetector::Verbosity.new.should_not == nil
  end
  ...
  it "can return its parent environment" do
    Rbdb::Settings::Lock::DeadlockDetector::Verbosity.new.parent_environment.should_not == nil
  end
  ...
  it "can return its parent settings controller" do
    Rbdb::Settings::Lock::DeadlockDetector::Verbosity.new.parent_settings_controller.should_not == nil
  end
  ...
  it "can return its parent lock settings controller" do
    Rbdb::Settings::Lock::DeadlockDetector::Verbosity.new.parent_lock_settings_controller.should_not == nil
  end
  ...
  it "can return its parent lock deadlock settings controller" do
    Rbdb::Settings::Lock::DeadlockDetector::Verbosity.new.parent_lock_deadlock_detector_settings_controller.should_not == nil
  end
  ...
  it "can display additional information during deadlock detection" do
    verbosity_settings  = Rbdb::Settings::Lock::DeadlockDetector::Verbosity.new
