...
describe Rbdb::Settings::Replication::Verbosity do
  ...
  # Rbdb::Settings::Replication::Verbosity.new( environment )
  it "can be created with an environment" do
    Rbdb::Settings::Replication::Verbosity.new( @environment ).should_not == nil
  end

  # Rbdb::Settings::Replication::Verbosity.new( settings_controller )
  it "can be created with a settings controller" do
    Rbdb::Settings::Replication::Verbosity.new( Rbdb::Settings.new ).should_not == nil
  end

  # Rbdb::Settings::Replication::Verbosity.new( replication_settings_controller )
  it "can be created with a replication settings controller" do
    Rbdb::Settings::Replication::Verbosity.new( Rbdb::Settings::Replication.new ).should_not == nil
  end

  # Rbdb::Settings::Replication::Verbosity.new
  it "can be created with no argument specified" do
    Rbdb::Settings::Replication::Verbosity.new.should_not == nil
  end
  ...
  it "can return its parent environment" do
    Rbdb::Settings::Replication::Verbosity.new.parent_environment.should_not == nil
  end
  ...
  it "can return its parent settings controller" do
    Rbdb::Settings::Replication::Verbosity.new.parent_settings_controller.should_not == nil
  end
  ...
  it "can return its parent replication settings controller" do
    Rbdb::Settings::Replication::Verbosity.new.parent_replication_settings_controller.should_not == nil
  end
  ...
  it "can be set to display all replication information" do
    verbosity_settings  = Rbdb::Settings::Replication::Verbosity.new
