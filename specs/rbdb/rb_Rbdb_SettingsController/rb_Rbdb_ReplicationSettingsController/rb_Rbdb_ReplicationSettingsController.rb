...
describe Rbdb::Settings::Replication do
  ...
  # Rbdb::Settings::Replication.new( environment )
  it "can be created with an environment" do
    @environment.open
    Rbdb::Settings::Replication.new( @environment ).should_not == nil
  end

  # Rbdb::Settings::Replication.new( settings_controller )
  it "can be created with a settings controller" do
    @environment.open
    Rbdb::Settings::Replication.new( Rbdb::Settings.new ).should_not == nil
  end

  # Rbdb::Settings::Replication.new
  it "can be created with no argument specified" do
    @environment.open
    Rbdb::Settings::Replication.new.should_not == nil
  end
  ...
  it "can return its parent environment" do
    @environment.open
    Rbdb::Settings::Replication.new.parent_environment.should_not == nil
  end
  ...
  it "can return its parent settings controller" do
    @environment.open
    Rbdb::Settings::Replication.new.parent_settings_controller.should_not == nil
  end
  ...
  it "can be turned on or off and report whether it is on or off" do
    replication_settings  = Rbdb::Settings::Replication.new( @environment )
  ...
  it "can set its host" do
    @environment.open
    replication_settings  = Rbdb::Settings::Replication.new
  ...
  it "can return its election settings controller" do
    @environment.open
    Rbdb::Settings::Replication.new.election_settings_controller.is_a?( Rbdb::Settings::Replication::Election ).should == true
  end
  ...
  it "can return its timeout settings controller" do
    @environment.open
    Rbdb::Settings::Replication.new.timeout_settings_controller.is_a?( Rbdb::Settings::Replication::Timeout ).should == true
  end
