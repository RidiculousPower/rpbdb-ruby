...
#define RPBDB_RUBY_ENVIRONMENT_CLASS																	"RPbdb::Environment"
#define RPBDB_RUBY_DATABASE_CLASS																		"RPbdb::Environment::DatabaseController::Database"

#define RPBDB_RB_VARIABLE_ENVIRONMENT_STORAGE								"@rpbdb__environment"
#define RPBDB_RB_VARIABLE_DATABASE_STORAGE										"@rpbdb__database_storage"
#define RPBDB_RB_VARIABLE_PRIMARY_KEY_METHOD									"@rpbdb__primary_key_method"	
#define RPBDB_RB_VARIABLE_UNIQUE_SECONDARY_KEY_METHODS				"@rpbdb__unique_secondary_key_methods"	
#define RPBDB_RB_VARIABLE_NONUNIQUE_SECONDARY_KEY_METHODS		"@rpbdb__nonunique_secondary_key_methods"	
#define RPBDB_RB_VARIABLE_STORED_INITIALIZE_ARGUMENTS				"@rpbdb__stored_initialize_arguments"	
#define RPBDB_RB_VARIABLE_IDENTIFY_AS_WAITLIST								"@rpbdb__identify_for_rpbdb_as_wait_list"
#define RPBDB_RB_VARIABLE_IDENTIFY_AS												"@rpbdb__identify_for_rpbdb_as"
#define RPBDB_RB_VARIABLE_INITIALIZED												"@rpbdb__initialized"
#define RPBDB_RB_VARIABLE_CONFIGURED													"@rpbdb__configured"
#define RPBDB_RB_VARIABLE_CURSOR_CONTEXT_STORAGE							"@rpbdb__cursor_context_storage"
#define RPBDB_RB_VARIABLE_UNIQUE_JOIN_DECLARATION_HASH					"@rpbdb__unique_join_declaration_hash"

#define RPBDB_RUBY_ERROR_PRIMARY_KEY_MISSING																				"Primary key method has not been specified."
#define RPBDB_RUBY_ERROR_MISSING_DATABASE																					"RPbdb object missing database."
#define RPBDB_RUBY_ERROR_DEFAULT_ENVIRONMENT_NULL																	"Environment was missing."
#define RPBDB_RUBY_ERROR_ENVIRONMENT_NULL																					"Default environment was missing."
#define RPBDB_RUBY_ERROR_MISSING_UNIQUE_KEY_METHOD																	"RPbdb object lacks method to retrieve sufficient information for unique key."
#define RPBDB_RUBY_ERROR_MISSING_UNIQUE_KEY																				"RPbdb object lacks sufficient information for unique key."
#define RPBDB_RUBY_ERROR_DATABASE_ARGUMENT_UNKNOWN_TYPE														"Database parameter was of unknown type."
#define RPBDB_RUBY_ERROR_ENVIRONMENT_UNKNOWN_TYPE																	"Environment parameter was of unknown type."
#define RPBDB_RUBY_ERROR_MULTIPLE_WRITE_REQUIRES_CALL_TO_CLASS_OBJECT							"Multiple record write requires call to class object."
#define RPBDB_RUBY_ERROR_MULTIPLE_RETRIEVE_REQUIRES_CALL_TO_CLASS_OBJECT						"Multiple record retrieve requires call to class object."
#define RPBDB_RUBY_ERROR_MULTIPLE_DELETE_REQUIRES_CALL_TO_CLASS_OBJECT							"Multiple record delete requires call to class object."
#define RPBDB_RUBY_ERROR_INSTANCE_RETRIEVE_REQUIRES_OBJECT_TO_HOLD_RETRIEVE_DATA		"Retrieval by instance requires object instance to hold retrieval data."
#define RPBDB_RUBY_ERROR_RETRIEVAL_KEY_WAS_NOT_UNIQUE															"Retrieval key was not unique."
#define RPBDB_RUBY_ERROR_TOO_MANY_ARGUMENTS_PROVIDED_FOR_DB_OBJECT_INITIALIZE			"RPbdb object has too many methods specified for arguments to initialize (%ld); expected %i."
#define RPBDB_RUBY_ERROR_TOO_FEW_ARGUMENTS_PROVIDED_FOR_DB_OBJECT_INITIALIZE				"RPbdb object has too few methods specified for arguments to initialize (%ld); expected %i."
#define RPBDB_RUBY_ERROR_INITIALIZE_ARGUMENT_METHOD_DOES_NOT_EXIST									"Method provided for RPbdb object initialize (%s) does not exist."
#define RPBDB_RUBY_ERROR_CURSOR_FOR_JOIN_REPORTED_NO_RECORD												"Cursor requested for join reported no record exists for key."
#define RPBDB_RUBY_ERROR_IDENTIFY_AS_CALLED_ON_INSTANCE														":identify_for_rpbdb_as should only called on a class, not an instance."
#define RPBDB_RUBY_ERROR_UNABLE_TO_FIND_ENUMERATION_FRAME													"Unable to find previous enumeration frame for corresponding iteration cursor."
#define RPBDB_RUBY_ERROR_NO_DATABASE_FOR_INDEX																			"No database existed for requested index."
#define RPBDB_RUBY_ERROR_CURSOR_SET_KEY_DID_NOT_EXIST                              "Key specified to locate cursor did not exist."
...
void Init_rb_RPbdb_Module()	{
	...
	rb_define_method(						rb_mRPbdb,	"configure_rpbdb",												rb_RPbdb_DatabaseObject_configureRPbdb,									0 );
                                                                                                                              
	rb_define_method(						rb_mRPbdb,	"init_rpbdb",														rb_RPbdb_DatabaseObject_initRPbdb,											0 );
	rb_define_singleton_method(	rb_mRPbdb,	"init_rpbdb",														rb_RPbdb_DatabaseObject_initRPbdb,											0 );
		                                                                                                                          
	rb_define_method(						rb_mRPbdb,	"identify_for_rpbdb_as",									rb_RPbdb_DatabaseObject_identifyAs,										0 );
                        			                                                                                                      
	rb_define_method(						rb_mRPbdb,	"initialized?",													rb_RPbdb_DatabaseObject_hasInitialized,								0 );
	rb_define_alias(						rb_mRPbdb,	"has_initialized?",											"initialized?" );                                     
                        			                                                                                                      
	rb_define_method(						rb_mRPbdb,	"configured?",													rb_RPbdb_DatabaseObject_hasConfigured,									0 );
	rb_define_alias(						rb_mRPbdb, "has_configured?",											"configured?" );                                      
                        			                                                                                                      
	rb_define_method(						rb_mRPbdb,	"environment",													rb_RPbdb_DatabaseObject_environment,										0 );
	rb_define_method(						rb_mRPbdb,	"environment=",													rb_RPbdb_DatabaseObject_setEnvironment,								1 );

	//	Default database for write/retrieve/delete
	//	Setting a default automatically adds the database to permissible list
	rb_define_method(						rb_mRPbdb,	"database",															rb_RPbdb_DatabaseObject_database,											0 );
	rb_define_method(						rb_mRPbdb,	"database_with_index",										rb_RPbdb_DatabaseObject_databaseWithIndex,							1);
	rb_define_alias(						rb_mRPbdb,	"index",																"database_with_index" );
	rb_define_method(						rb_mRPbdb,	"database=",														rb_RPbdb_DatabaseObject_setDatabase,										1 );
	rb_define_alias(						rb_mRPbdb,	"set_database",													"database=" );
	rb_define_method(						rb_mRPbdb,	"databases",														rb_RPbdb_DatabaseObject_databases,											0 );
	rb_define_method(						rb_mRPbdb,	"set_store_as_class",										rb_RPbdb_DatabaseObject_setStoreAsClass,								1 );
	rb_define_method(						rb_mRPbdb,	"cursor",																rb_RPbdb_DatabaseObject_cursor,												-1 );
	rb_define_method(						rb_mRPbdb,	"cursors",															rb_RPbdb_DatabaseObject_cursors,												0 );

	//	Primary key method for retrieving object
	rb_define_method(						rb_mRPbdb,	"primary_key_value",										rb_RPbdb_DatabaseObject_primaryKeyValue,								0 );
	rb_define_method(						rb_mRPbdb,	"primary_key_method",										rb_RPbdb_DatabaseObject_primaryKeyMethod,							0 );
	rb_define_alias(						rb_mRPbdb,	"primary_key",													"primary_key_method" );
	rb_define_method(						rb_mRPbdb,	"primary_key_method=",									rb_RPbdb_DatabaseObject_setPrimaryKeyMethod,						1 );
	rb_define_alias(						rb_mRPbdb,	"key_method="	,													"primary_key_method=" );
	rb_define_alias(						rb_mRPbdb,	"set_primary_key_method",								"primary_key_method=" );
	...
	//	with the extension __idx__<rpbdb/secondaryKeyMethod>      
	
	rb_define_method(						rb_mRPbdb,	"key_methods",													rb_RPbdb_DatabaseObject_keyMethods,										0 );
	rb_define_method(						rb_mRPbdb,	"unique_key_methods",										rb_RPbdb_DatabaseObject_uniqueKeyMethods,							0 );
	rb_define_method(						rb_mRPbdb,	"seconday_key_methods",									rb_RPbdb_DatabaseObject_secondaryKeyMethods,						0 );
	rb_define_method(						rb_mRPbdb,	"unique_secondary_key_methods",					rb_RPbdb_DatabaseObject_uniqueSecondaryKeyMethods,			0 );
	rb_define_method(						rb_mRPbdb,	"non_unique_secondary_key_methods",			rb_RPbdb_DatabaseObject_nonUniqueSecondaryKeyMethods,	0 );
	                      			
	rb_define_method(						rb_mRPbdb,	"unique_secondary_key_methods+=",				rb_RPbdb_DatabaseObject_addUniqueSecondaryKeyMethod,		-1 );
	rb_define_alias(						rb_mRPbdb,	"add_unique_key_method",								"unique_secondary_key_methods+=" );
	rb_define_alias(						rb_mRPbdb,	"add_unique_key_methods",								"unique_secondary_key_methods+=" );
	rb_define_alias(						rb_mRPbdb,	"add_unique_secondary_key_method",			"unique_secondary_key_methods+=" );
	rb_define_alias(						rb_mRPbdb,	"add_unique_secondary_key_methods",			"unique_secondary_key_methods+=" );
	rb_define_method(						rb_mRPbdb,	"declare_unique_join",									rb_RPbdb_DatabaseObject_declareUniqueJoin,							-1 );
	rb_define_method(						rb_mRPbdb,	"is_unique_join?",											rb_RPbdb_DatabaseObject_isUniqueJoin,									-1 );
	rb_define_method(						rb_mRPbdb,	"secondary_key_methods+=",							rb_RPbdb_DatabaseObject_addSecondaryKeyMethod,					-1 );
	rb_define_alias(						rb_mRPbdb,	"add_key_method",												"secondary_key_methods+=" );
	rb_define_alias(						rb_mRPbdb,	"add_key_methods",											"secondary_key_methods+=" );
	rb_define_alias(						rb_mRPbdb,	"add_secondary_key_method",							"secondary_key_methods+=" );
	rb_define_alias(						rb_mRPbdb,	"add_secondary_key_methods",						"secondary_key_methods+=" );
                        			
	rb_define_method(						rb_mRPbdb,	"keys",																	rb_RPbdb_DatabaseObject_keys,													0 );
	rb_define_method(						rb_mRPbdb,	"unique_key",														rb_RPbdb_DatabaseObject_uniqueKey,											0 );
	rb_define_alias(						rb_mRPbdb,	"has_unique_key?",											"unique_key" );
	rb_define_method(						rb_mRPbdb,	"unique_keys",													rb_RPbdb_DatabaseObject_uniqueKeys,										0 );
	rb_define_method(						rb_mRPbdb,	"secondary_keys",												rb_RPbdb_DatabaseObject_secondaryKeys,									0 );
	rb_define_method(						rb_mRPbdb,	"unique_secondary_keys",								rb_RPbdb_DatabaseObject_uniqueSecondaryKeys,						0 );
	rb_define_method(						rb_mRPbdb,	"non_unique_secondary_keys",						rb_RPbdb_DatabaseObject_nonUniqueSecondaryKeys,				0 );
	
	//	Write methods
	rb_define_method(						rb_mRPbdb,	"write",																rb_RPbdb_DatabaseObject_write,													-1 );
	rb_define_alias(						rb_mRPbdb,	"write_to_db",													"write" );

	//	Retrieve methods	
	rb_define_method(						rb_mRPbdb,	"retrieve",															rb_RPbdb_DatabaseObject_retrieve,											-1 );
	rb_define_alias(						rb_mRPbdb,	"retrieve_from_db",											"retrieve" );

	rb_define_method(						rb_mRPbdb,	"exists?",															rb_RPbdb_DatabaseObject_exists,												-1 );
	rb_define_alias(						rb_mRPbdb,	"exists_in_db?",												"exists?" );

	//	Delete methods
	rb_define_method(						rb_mRPbdb,	"delete",																rb_RPbdb_DatabaseObject_delete,												-1 );
	rb_define_alias(						rb_mRPbdb,	"delete_from_db",												"delete" );

	rb_define_method(						rb_mRPbdb,	"iterate",															rb_RPbdb_DatabaseObject_iterate,												-1 	);
	rb_define_alias(						rb_mRPbdb,	"each",																	"iterate"	);
	rb_define_method(						rb_mRPbdb,	"iterate_duplicates",										rb_RPbdb_DatabaseObject_iterateDuplicates,							-1 	);
	rb_define_alias(						rb_mRPbdb,	"each_duplicate",												"iterate_duplicates"	);
	rb_define_method(						rb_mRPbdb,	"iterate_keys",													rb_RPbdb_DatabaseObject_iterateKeys,										-1 	);
	rb_define_alias(						rb_mRPbdb,	"each_key",															"iterate_keys"	);
...
VALUE rb_RPbdb_DatabaseObject_initRPbdb( VALUE	rb_klass_self )	{
	...
	//	is always declared when RPbdb is included
	
	//	we want to look up the call chain until we find an object that responds to init_rpbdb
	//	
	
	if ( rb_obj_respond_to(	rb_superclass_self,
							rb_intern( RPBDB_FUNCTION_INIT ),
							0 ) )	{
...
VALUE rb_RPbdb_DatabaseObject_identifyAs(	VALUE	rb_klass_self __attribute__((unused)) )	{
...
VALUE rb_RPbdb_DatabaseObject_setEnvironment(	VALUE	rb_self,
	...
	rb_iv_set(	rb_klass,
							RPBDB_RB_VARIABLE_ENVIRONMENT_STORAGE,
							rb_environment );
...
VALUE rb_RPbdb_DatabaseObject_environment(	VALUE	rb_self )	{
	...
	VALUE	rb_environment	=	rb_RPbdb_DatabaseObject_internal_getEnvironment( rb_self );
	
	if ( rb_environment == Qnil )	{
		rb_environment	=	rb_RPbdb_DatabaseObject_requireDefaultEnvironment( rb_self );
	}
...
VALUE rb_RPbdb_DatabaseObject_database(	VALUE	rb_self )	{
	...
	VALUE	rb_primary_index_method	=	rb_RPbdb_DatabaseObject_primaryKeyMethod( rb_self );
	
	//	See if we have a database set already 
	VALUE	rb_database = rb_RPbdb_DatabaseObject_internal_getDatabase( rb_self,
	...
	VALUE	rb_pathsafe_class_name	=	rb_RPbdb_DatabaseObject_pathsafeClassname( rb_self );
	
	//	If we get here, we don't have a database set, so we're going to set one using our class name
	rb_RPbdb_DatabaseObject_setDatabase(	rb_self, 
																			rb_pathsafe_class_name );
	
	//	Now we've set a database, we can return it normally
	return rb_RPbdb_DatabaseObject_database( rb_self );
}
...
VALUE rb_RPbdb_DatabaseObject_databases( VALUE rb_self )	{
	...
	VALUE	rb_databases	=	rb_iv_get(	rb_klass,
											RPBDB_RB_VARIABLE_DATABASE_STORAGE );
...
VALUE rb_RPbdb_DatabaseObject_databaseWithIndex(	VALUE	rb_self,
	...
	if ( rb_index_method == Qnil )	{
		...
		rb_database	=	rb_RPbdb_DatabaseObject_database( rb_self );
	}
	else {
		
		rb_database	=	rb_RPbdb_DatabaseObject_internal_getDatabase(	rb_self,
																		rb_index_method );
	}
...
VALUE rb_RPbdb_DatabaseObject_setDatabase(	VALUE	rb_self,
	...
	if ( TYPE( rb_database_or_name ) == T_SYMBOL )	{
		...
		C_RPBDB_ENVIRONMENT( rb_RPbdb_DatabaseObject_environment( rb_self ), c_environment );
		char*	c_database_name	=	StringValuePtr( rb_database_name_string );
		RPbdb_Database*	c_database	=	RPbdb_DatabaseController_newDatabase(	RPbdb_Environment_databaseController( c_environment ),
																																				c_database_name );
		
		rb_database	=	RUBY_RPBDB_DATABASE_OBJECT_DATABASE( c_database );
	}
	...
	//	we can't have nothing because we required 1 arg
		...
		rb_RPbdb_DatabaseObject_internal_requireObjectVerifyAsDatabase( rb_database );				
	}
...
VALUE rb_RPbdb_DatabaseObject_setStoreAsClass(	VALUE	rb_self,
	...
	rb_RPbdb_DatabaseObject_setDatabase(	rb_self,
																			rb_RPbdb_DatabaseObject_pathsafeClassname(	rb_store_as_class ) );
	return rb_self;
}
...
VALUE rb_RPbdb_DatabaseObject_primaryKeyMethod(	VALUE	rb_self )	{
	...
	return rb_iv_get(	rb_klass,
						RPBDB_RB_VARIABLE_PRIMARY_KEY_METHOD );
}
...
VALUE rb_RPbdb_DatabaseObject_setPrimaryKeyMethod(	VALUE	rb_self,
	...
	VALUE	rb_databases			=	rb_RPbdb_DatabaseObject_databases( rb_self );
...
VALUE rb_RPbdb_DatabaseObject_primaryKeyValue(	VALUE	rb_self )	{
	...
	return rb_funcall(	rb_self,
						SYM2ID( rb_RPbdb_DatabaseObject_primaryKeyMethod( rb_self ) ),
						0 );
}
...
VALUE rb_RPbdb_DatabaseObject_secondaryKeyMethods(	VALUE	rb_self )	{
	...
	return rb_ary_concat(	rb_RPbdb_DatabaseObject_uniqueSecondaryKeyMethods( rb_self ),
							rb_RPbdb_DatabaseObject_nonUniqueSecondaryKeyMethods( rb_self ) );
}
...
VALUE rb_RPbdb_DatabaseObject_addSecondaryKeyMethod(	int	argc,
	...
	rb_RPbdb_DatabaseObject_internal_addSecondaryKeyMethods(	rb_self,
																RPBDB_RB_VARIABLE_NONUNIQUE_SECONDARY_KEY_METHODS,
																argc,
																args	);
...
VALUE rb_RPbdb_DatabaseObject_addUniqueSecondaryKeyMethod(	int	argc,
	...
	rb_RPbdb_DatabaseObject_internal_addSecondaryKeyMethods(	rb_self,
																RPBDB_RB_VARIABLE_UNIQUE_SECONDARY_KEY_METHODS,
																argc,
																args	);
...
VALUE rb_RPbdb_DatabaseObject_uniqueSecondaryKeyMethods(	VALUE	rb_self )	{
	...
	return rb_RPbdb_DatabaseObject_internal_getClassInstanceArray(	rb_self,
																	RPBDB_RB_VARIABLE_UNIQUE_SECONDARY_KEY_METHODS	);
}
...
VALUE rb_RPbdb_DatabaseObject_declareUniqueJoin(	int		argc,
	...
	VALUE	rb_unique_join_declaration_hash	=	rb_RPbdb_DatabaseObject_internal_uniqueJoinDeclarationHash( rb_self );
	...
	for ( c_which_arg = 0 ; c_which_arg < argc ; c_which_arg++ )	{
		...
		rb_RPbdb_DatabaseObject_internal_addChainedMember(	rb_unique_join_declaration_hash,
																											rb_indexes_array );
	}
...
VALUE rb_RPbdb_DatabaseObject_uniqueKeyMethod(	VALUE	rb_self )	{
	...
	VALUE	rb_unique_key_methods	=	rb_RPbdb_DatabaseObject_uniqueKeyMethods( rb_self );
...
VALUE rb_RPbdb_DatabaseObject_uniqueKeyMethods(	VALUE	rb_self )	{
	...
	VALUE	rb_primary_key_method				=	rb_RPbdb_DatabaseObject_primaryKeyMethod( rb_self );
	
	VALUE	rb_unique_secondary_key_methods		=	rb_RPbdb_DatabaseObject_uniqueSecondaryKeyMethods( rb_self );
...
VALUE rb_RPbdb_DatabaseObject_keyMethods(	VALUE	rb_self )	{
	...
	VALUE	rb_secondary_key_methods	=	rb_RPbdb_DatabaseObject_secondaryKeyMethods( rb_self );
...
VALUE rb_RPbdb_DatabaseObject_uniqueKey( VALUE	rb_self )	{
	...
	if ( rb_primary_key_method == Qnil )	{
		...
		rb_raise( rb_eRuntimeError, RPBDB_RUBY_ERROR_PRIMARY_KEY_MISSING );
	}

	//	First, check primary key
	VALUE	rb_primary_key	=	rb_RPbdb_DatabaseObject_primaryKey( rb_self );
...
VALUE rb_RPbdb_DatabaseObject_isUniqueKeyMethod(	VALUE	rb_self,
	...
	return rb_ary_includes(	rb_RPbdb_DatabaseObject_uniqueKeyMethods( rb_self ), 
...
VALUE rb_RPbdb_DatabaseObject_secondaryKeys(	VALUE	rb_self )	{
	...
	//	get key methods
	VALUE	rb_key_methods	=	rb_RPbdb_DatabaseObject_secondaryKeyMethods( rb_self );
...
VALUE rb_RPbdb_DatabaseObject_uniqueSecondaryKey(	VALUE	rb_self )	{
	...
	VALUE	rb_unique_secondary_keys	=	rb_RPbdb_DatabaseObject_uniqueSecondaryKeys( rb_self );
...
VALUE rb_RPbdb_DatabaseObject_uniqueSecondaryKeys(	VALUE	rb_self )	{
	...
	//	get key methods
	VALUE	rb_key_methods	=	rb_RPbdb_DatabaseObject_uniqueSecondaryKeyMethods( rb_self );
...
VALUE rb_RPbdb_DatabaseObject_nonUniqueSecondaryKeys(	VALUE	rb_self )	{
	...
	//	get key methods
	VALUE	rb_key_methods	=	rb_RPbdb_DatabaseObject_nonUniqueSecondaryKeyMethods( rb_self );
...
VALUE rb_RPbdb_DatabaseObject_keys(	VALUE	rb_self )	{
	...
	//	get key methods
	VALUE	rb_key_methods	=	rb_RPbdb_DatabaseObject_keyMethods( rb_self );
...
VALUE rb_RPbdb_DatabaseObject_requireEnvironment( VALUE rb_self )	{
	...
	VALUE	rb_environment	=	rb_RPbdb_DatabaseObject_environment( rb_self );
	
	if ( rb_environment == Qnil )	{
		rb_raise( rb_eArgError, RPBDB_RUBY_ERROR_DEFAULT_ENVIRONMENT_NULL );
	}
	return rb_environment;
}
...
VALUE rb_RPbdb_DatabaseObject_requireDefaultEnvironment( VALUE rb_self __attribute__((unused)) )	{
	
	//	Ask runtime storage if a default environment exists
	RPbdb_Environment*	c_current_working_environment	=	RPbdb_RuntimeStorageController_currentWorkingEnvironment( RPbdb_RuntimeStorageController_sharedInstance() );
	if ( c_current_working_environment == NULL )	{
		rb_raise( rb_eArgError, RPBDB_RUBY_ERROR_ENVIRONMENT_NULL );
	}
	return RUBY_RPBDB_ENVIRONMENT( c_current_working_environment );
}
...
VALUE rb_RPbdb_DatabaseObject_requireDatabaseWithIndex(	VALUE	rb_self,
	...
	VALUE	rb_database	=	rb_RPbdb_DatabaseObject_databaseWithIndex(	rb_self,
																		rb_index );
	
	if ( rb_database == Qnil )	{
		rb_raise( rb_eArgError, RPBDB_RUBY_ERROR_MISSING_DATABASE );
	}
	return rb_database;
}
...
VALUE rb_RPbdb_DatabaseObject_requireUniqueKeyMethod( VALUE rb_self )	{
	...
	if ( ( rb_unique_key_method = rb_RPbdb_DatabaseObject_uniqueKeyMethod( rb_self ) ) == Qnil )	{		
		//	Throw an error - missing key
		rb_raise( rb_eArgError, RPBDB_RUBY_ERROR_MISSING_UNIQUE_KEY_METHOD );
	}	
...
VALUE rb_RPbdb_DatabaseObject_requireUniqueKey( VALUE rb_self )	{
	...
	VALUE	rb_unique_key_method	=	rb_RPbdb_DatabaseObject_requireUniqueKeyMethod( rb_self );
	...
	if ( ( rb_unique_key = rb_funcall(	rb_self,
										...
										0 ) ) == Qnil )	{		
		//	Throw an error - missing key
		rb_raise( rb_eArgError, RPBDB_RUBY_ERROR_MISSING_UNIQUE_KEY );
	}
...
VALUE rb_RPbdb_DatabaseObject_write(	int	argc,
	...
	//	If we have an instance, we write it
		...
		if ( NIL_P( rb_RPbdb_DatabaseObject_database( rb_self ) ) )	{
			//	Throw an error - missing database
			rb_raise( rb_eArgError, RPBDB_RUBY_ERROR_MISSING_DATABASE );
		}
		
		rb_RPbdb_DatabaseObject_internal_ensureInitialized( rb_self );
		
		RPbdb_Record*	c_record	=	rb_RPbdb_DatabaseObject_internal_compactRetrievalObject( rb_self );		

		RPbdb_Database_write(	c_record->parent_database,
								c_record );
	}
...
VALUE rb_RPbdb_DatabaseObject_exists(	int	argc,
	...
	if ( TYPE( rb_self ) == T_CLASS )	{
		...
		for ( which_object = 0 ; which_object < argc ; which_object++ )	{
			...
			C_RPBDB_DATABASE_OBJECT_DATABASE( rb_RPbdb_DatabaseObject_database( rb_self ), c_database );
			...
			rb_RPbdb_DatabaseObject_internal_packRubyObjectForDatabaseStorage(	args[ which_object ],
																																				c_record->key->wrapped_bdb_dbt,
																																				TRUE );
			
			//	and then we can call delete on the db with the prepared key
			if ( RPbdb_Database_retrieveRecord(	c_database,
												c_record ) == NULL )	{
	...
	//	If we have an instance
		...
		VALUE	rb_key	=	Qnil;
		//	Make sure we have a key sufficient for retrieving
		if ( ( rb_key = rb_RPbdb_DatabaseObject_uniqueKey( rb_self ) ) == Qnil )	{		
			//	Throw an error - missing key
			rb_raise( rb_eArgError, RPBDB_RUBY_ERROR_MISSING_UNIQUE_KEY );
		}
		
		VALUE	rb_database	=	rb_RPbdb_DatabaseObject_database( rb_self );
		...
		rb_RPbdb_DatabaseObject_internal_packRubyObjectForDatabaseStorage(	rb_key,
																																			c_record->key->wrapped_bdb_dbt,
																																			TRUE );
...
VALUE rb_RPbdb_DatabaseObject_retrieve(	int	argc,
	...
	if ( TYPE( rb_self ) == T_CLASS )	{
		...
		return_object	=	rb_RPbdb_DatabaseObject_internal_retrieveEachOfMultipleFromParameters(	argc,
																										args,
																										rb_self );
	...
	//	If we have an instance, we return the current db record corresponding - we can simply pass self to internal retrieve
		...
		return_object	=	rb_RPbdb_DatabaseObject_internal_retrieveSelfAsPrimaryPackedData(	rb_self );
	}
...
VALUE rb_RPbdb_DatabaseObject_cursor( int	argc,
	...
	VALUE	rb_database	=	Qnil;
	if ( rb_index != Qnil )	{
		rb_database	=	rb_RPbdb_DatabaseObject_databaseWithIndex(	rb_self,
																	rb_index );
	}
	else {
		rb_database	=	rb_RPbdb_DatabaseObject_database( rb_self );
	...
	rb_database_object_cursor	=	rb_RPbdb_DatabaseObjectDatabase_cursor( rb_database );
...
VALUE rb_RPbdb_DatabaseObject_cursors( VALUE rb_self )	{
	...
	return rb_RPbdb_Database_cursorController( rb_database );
}
...
VALUE rb_RPbdb_DatabaseObject_iterate(	int	argc,
	...
	VALUE	rb_cursor	=	rb_RPbdb_DatabaseObject_cursor( 1,
															& rb_index,
															rb_self );

	rb_RPbdb_DatabaseObject_internal_beginCursorContext(	rb_self,
															rb_cursor );
	
	if ( rb_RPbdb_DatabaseObjectCursor_retrieveFirst( rb_cursor ) == Qnil )	{
		return Qnil;
	}

	//	Call iterate on the cursor
	VALUE	return_value	=	rb_RPbdb_DatabaseObjectCursor_iterate(	argc,
																		args,
																		rb_cursor );

	rb_RPbdb_DatabaseObject_internal_endCursorContext(	rb_self,
														rb_cursor );
...
VALUE rb_RPbdb_DatabaseObject_iterateDuplicates(	int	argc,
	...
	else if ( ( rb_cursor = rb_RPbdb_DatabaseObject_internal_cursorForCallingContext( rb_self ) ) == Qnil )	{

		//	if we can't find the last corresponding enumeration frame, throw an error
		rb_raise( rb_eArgError, RPBDB_RUBY_ERROR_UNABLE_TO_FIND_ENUMERATION_FRAME );
	}
	
	RPbdb_DatabaseCursor*	c_database_cursor	=	NULL;
	C_RPBDB_DATABASE_OBJECT_CURSOR( rb_cursor, c_database_cursor );
	
	//	Call iterate on the cursor
	return rb_RPbdb_DatabaseObjectCursor_iterateDuplicates(	argc,
															args,
															rb_cursor );	
}
...
VALUE rb_RPbdb_DatabaseObject_iterateKeys(	int	argc,
	...
	if ( rb_RPbdb_DatabaseCursor_retrieveFirst( rb_cursor ) == Qnil )	{
		return Qnil;
	}
	
	//	Call iterate on the cursor
	VALUE	rb_return_value	=	rb_RPbdb_DatabaseObjectCursor_iterateKeys(	1,
...
static int rb_RPbdb_DatabaseObject_internal_iterateEnvironments(	VALUE	rb_environment,
                                                                VALUE	rb_identify_for_rpbdb_as_array,
...
VALUE rb_RPbdb_DatabaseObject_internal_cursorForCallingContext( VALUE rb_self )	{
	...
	if ( RHASH_SIZE( rb_cursor_context_storage_hash ) )	{
		 ...
		 rb_cursor	=	rb_rescue(	rb_RPbdb_DatabaseObject_internal_each_backtrace_frame_exception_wrapper, 
									rb_args,
									rb_RPbdb_DatabaseObject_internal_each_backtrace_frame_exception_return_cursor, 
									rb_args );		
	}
...
VALUE rb_RPbdb_DatabaseObject_internal_each_backtrace_frame_exception_wrapper( VALUE rb_args )	{
...
VALUE rb_RPbdb_DatabaseObject_internal_each_backtrace_frame_exception_return_cursor( VALUE rb_args )	{
...
void rb_RPbdb_DatabaseObject_internal_beginCursorContext(	VALUE	rb_self,
															VALUE	rb_cursor )	{
...
void rb_RPbdb_DatabaseObject_internal_endCursorContext(	VALUE	rb_self,
...
VALUE rb_RPbdb_DatabaseObject_internal_cursorContextStorageHash( VALUE rb_self )	{
	...
	if ( ( rb_cursor_context_storage_hash	=	rb_iv_get(	rb_klass,
															RPBDB_RB_VARIABLE_CURSOR_CONTEXT_STORAGE ) ) == Qnil )	{
		rb_cursor_context_storage_hash	=	rb_hash_new();
		rb_iv_set(	rb_klass,
					RPBDB_RB_VARIABLE_CURSOR_CONTEXT_STORAGE,
					rb_cursor_context_storage_hash );
	}
...
VALUE rb_RPbdb_DatabaseObject_internal_cursorObjectContextStorageHash(	VALUE	rb_cursor_context_storage_hash,
...
VALUE rb_RPbdb_DatabaseObject_internal_getEnvironment(	VALUE	rb_self )	{
...
VALUE rb_RPbdb_DatabaseObject_internal_getDatabase( VALUE	rb_self,
													VALUE	rb_index_method )	{

	return rb_RPbdb_DatabaseObject_internal_getObjectFromClassInstanceHash(	rb_self,
																			RPBDB_RB_VARIABLE_DATABASE_STORAGE,
																			rb_index_method );
}
...
VALUE rb_RPbdb_DatabaseObject_internal_storeObjectInClassInstanceArray(	VALUE	rb_self,
																		char*	c_class_instance_array_name,
																		VALUE	rb_index_method	)	{
	
	//	We store databases in our class instance inside a hash by method
	VALUE	rb_storage	=	rb_RPbdb_DatabaseObject_internal_getClassInstanceArray(	rb_self,
...
VALUE rb_RPbdb_DatabaseObject_internal_getClassInstanceArray(	VALUE	rb_self,
...
VALUE rb_RPbdb_DatabaseObject_internal_storeObjectInClassInstanceHash(	VALUE	rb_self,
...
VALUE rb_RPbdb_DatabaseObject_internal_getObjectFromClassInstanceHash(	VALUE	rb_self,
																		char*	rb_class_instance_hash_name,
																		VALUE	rb_index_method )	{
...
void rb_RPbdb_DatabaseObject_internal_packRubyObjectForDatabaseStorage(	VALUE		rb_key,
																																				DBT*		c_key_dbt,
...
VALUE rb_RPbdb_DatabaseObject_internal_unpackRubyObjectFromDatabaseStorage( VALUE rb_marshal_encoded_string )	{
...
RPbdb_Record* rb_RPbdb_DatabaseObject_internal_compactRetrievalObject( VALUE	rb_self )	{
	...
	*********/
	...
	rb_RPbdb_DatabaseObject_internal_packRubyObjectForDatabaseStorage(	rb_self,
...
VALUE rb_RPbdb_DatabaseObject_internal_extractRetrievalKey( RPbdb_Record* c_retrieval_record )	{
	
	void*	c_string_for_marshalled_ruby_self	=	RPbdb_Record_rawKey( c_retrieval_record );
	...
	VALUE	rb_marshal_string	=	rb_str_new( c_string_for_marshalled_ruby_self,
												RPbdb_Record_keySize( c_retrieval_record ) );
	
	
	return rb_RPbdb_DatabaseObject_internal_unpackRubyObjectFromDatabaseStorage( rb_marshal_string );	
}
...
VALUE rb_RPbdb_DatabaseObject_internal_extractRetrievalData( RPbdb_Record* c_retrieval_record )	{

	void*	c_string_for_marshalled_ruby_self	=	RPbdb_Record_rawData( c_retrieval_record );
	
	//	Turn stored C string (converted from rb string for marshal data) back into Ruby string
	VALUE	rb_marshal_string	=	rb_str_new( c_string_for_marshalled_ruby_self,
												RPbdb_Record_dataSize( c_retrieval_record ) );
...
VALUE rb_RPbdb_DatabaseObject_internal_retrieveEachOfMultipleFromParameters(	int	argc,
																					VALUE*	args,
																					VALUE	rb_klass_self )	{
	...
	for ( which_object = 0 ; which_object < argc ; which_object++ )	{
		...
		rb_ary_push(	rb_return_array,
						rb_RPbdb_DatabaseObject_internal_retrieveSelfAsPrimaryPackedDataFromParameterDescription(	rb_klass_self,
																													args[ which_object ] ) );
	}
...
VALUE rb_RPbdb_DatabaseObject_internal_retrieveSelfAsPrimaryPackedDataFromParameterDescription(	VALUE	rb_klass_self,
	...
	if ( TYPE( rb_unique_key_parameter ) == T_ARRAY )	{
		...
		rb_ary_push(	rb_return_array,
						rb_RPbdb_DatabaseObject_internal_retrieveEachOfMultipleFromParameterDataArray(	rb_klass_self,
	...
	//	we return either a record or a duplicates cursor or a join cursor
		...
		rb_ary_push(	rb_return_array,
					rb_RPbdb_DatabaseObject_internal_retrieveSelfAsPrimaryPackedDataHash(	rb_klass_self,
																							rb_unique_key_parameter ) );		
	}
	//	If it's not a hash or array we have a primary key - we return the record
		...
		rb_ary_push(	rb_return_array,
						rb_RPbdb_DatabaseObject_internal_retrieveSelfAsPrimaryPackedDataPrimaryKey(	rb_klass_self,
																									rb_unique_key_parameter ) );
	}
...
VALUE rb_RPbdb_DatabaseObject_internal_retrieveEachOfMultipleFromParameterDataArray(	VALUE	rb_klass_self,
																							VALUE	rb_unique_key_parameter )	{
...
VALUE rb_RPbdb_DatabaseObject_internal_retrieveSelfAsPrimaryPackedDataHash(	VALUE	rb_klass_self,
																																						VALUE	rb_unique_key_parameter )	{
	...
	if ( RHASH_SIZE( rb_unique_key_parameter ) == 1 )	{
		...
		rb_return_object	=	rb_RPbdb_DatabaseObject_internal_retrieveSelfAsPrimaryPackedDataMethodValueKeyHash(	rb_klass_self,
																																																						rb_unique_key_parameter	);
	}
	//	if we have more than one key pair then we are returning a join cursor
	else if ( RHASH_SIZE( rb_unique_key_parameter ) > 1 ) {

		VALUE	rb_database									=	rb_RPbdb_DatabaseObject_database( rb_klass_self );
		VALUE	rb_database_join_controller	=	rb_RPbdb_Database_joinController( rb_database );

		rb_return_object	=	rb_RPbdb_DatabaseJoinController_join(	1,
																															& rb_unique_key_parameter,
...
VALUE rb_RPbdb_DatabaseObject_internal_retrieveSelfAsPrimaryPackedDataPrimaryKey(	VALUE	rb_klass_self,
																																									VALUE	rb_unique_key_parameter )	{
	...
	rb_RPbdb_DatabaseObject_internal_packRubyObjectForDatabaseStorage(	rb_unique_key_parameter,
																																		c_record->key->wrapped_bdb_dbt,
																																		TRUE );
	
	RPbdb_Database_retrieveRecord(	c_database,
																c_record );
	
	VALUE	rb_object	=	rb_RPbdb_DatabaseObject_internal_extractRetrievalData( c_record );
...
VALUE rb_RPbdb_DatabaseObject_internal_retrieveSelfAsPrimaryPackedDataMethodValueKeyHash(	VALUE	rb_klass_self,
																																													VALUE	rb_unique_key_parameter )	{
	...
	if ( rb_RPbdb_DatabaseObject_isUniqueKeyMethod(	rb_klass_self,
		...
		//	we don't know which database corresponds to our retrieval key, but we do know the key method
		//	so we can ask the object's class for the corresponding database
		VALUE	rb_database	=	rb_RPbdb_DatabaseObject_databaseWithIndex(	rb_klass_self,
																																	rb_key_method_symbol );
		RPbdb_Database*	c_database	=	NULL;
		C_RPBDB_DATABASE_OBJECT_DATABASE( rb_database, c_database );
		...
		//	we know how to produce our retrieval key
		//	call packRubyObjectForDatabaseStorage on our key value (rb_key_value)
		rb_RPbdb_DatabaseObject_internal_packRubyObjectForDatabaseStorage(	rb_key_value,
																																			c_record->key->wrapped_bdb_dbt,
																																			TRUE );
		...
		if ( RPbdb_Database_retrieveRecord(	c_database,
			...
			rb_return_object	=	rb_RPbdb_DatabaseObject_internal_extractRetrievalData( c_record );
		}
	...
	//	if it's not, get a cursor
		...
		VALUE	rb_database	=	rb_RPbdb_DatabaseObject_databaseWithIndex(	rb_klass_self,
																																	rb_key_method_symbol );
		VALUE	rb_database_join_controller	=	rb_RPbdb_Database_joinController( rb_database );
		rb_return_object	=	rb_RPbdb_DatabaseJoinController_internal_cursorForIndexAtKeyValue(	rb_database_join_controller, 
																																													rb_key_method_symbol,
																																													rb_key_value );
	}
	return rb_return_object;
...
VALUE rb_RPbdb_DatabaseObject_internal_retrieveSelfAsPrimaryPackedData(	VALUE	rb_self	)	{
	
	//	Make sure we have sufficient key info for retrieval
	VALUE	rb_unique_key_method	=	rb_RPbdb_DatabaseObject_requireUniqueKeyMethod( rb_self );
	VALUE	rb_unique_key			=	rb_RPbdb_DatabaseObject_requireUniqueKey( rb_self );
	...
	VALUE	rb_database	=	rb_RPbdb_DatabaseObject_requireDatabaseWithIndex(	rb_self,
	...
	rb_RPbdb_DatabaseObject_internal_packRubyObjectForDatabaseStorage(	rb_unique_key,
																																		c_record->key->wrapped_bdb_dbt,
																																		TRUE );
	...
	VALUE	retrieved_rb_self	=	rb_RPbdb_DatabaseObject_internal_extractRetrievalData( c_record );
...
VALUE rb_RPbdb_DatabaseObject_internal_verifyObjectAsEnvironment( VALUE rb_object __attribute__((unused)) )	{
...
VALUE rb_RPbdb_DatabaseObject_internal_verifyObjectAsDatabase( VALUE rb_object )	{
	...
	return rb_RPbdb_DatabaseObject_internal_verifyObjectHasMethods(	rb_object,
...
void rb_RPbdb_DatabaseObject_internal_requireObjectVerifyAsEnvironment( VALUE rb_object __attribute__((unused)) )	{
	
	//	make sure object is of class RPbdb::Environment
...
void rb_RPbdb_DatabaseObject_internal_requireObjectVerifyAsDatabase( VALUE rb_object )	{
	
	if ( rb_RPbdb_DatabaseObject_internal_verifyObjectAsDatabase( rb_object ) == Qfalse )	{
		rb_raise( rb_eArgError, RPBDB_RUBY_ERROR_DATABASE_ARGUMENT_UNKNOWN_TYPE );
	}
}
...
VALUE rb_RPbdb_DatabaseObject_internal_verifyObjectHasMethods(	VALUE	rb_object,
...
VALUE rb_RPbdb_DatabaseObject_internal_addSecondaryKeyMethods(	VALUE		rb_self,
	...
	for ( which_arg = 0 ; which_arg < argc ; which_arg++ )	{
		...
		rb_RPbdb_DatabaseObject_internal_storeObjectInClassInstanceArray(	rb_self,
		...
		rb_RPbdb_DatabaseObject_internal_createAndAssociateSecondaryDatabase(	rb_self,
																				rb_secondary_key_method	);
	}
...
VALUE rb_RPbdb_DatabaseObject_internal_createAndAssociateSecondaryDatabase(	VALUE	rb_self,
																																						VALUE	rb_index_method_symbol )	{
	
	//	Get the primary from self
	VALUE	rb_primary_database	=	rb_RPbdb_DatabaseObject_database( rb_self );
	
	RPbdb_Database*	c_primary_database	=	NULL;
	C_RPBDB_DATABASE_OBJECT_DATABASE( rb_primary_database, c_primary_database );
	...
	VALUE	rb_secondary_database	=	rb_RPbdb_Database_new(	1,
																											& rb_nil,
																											rb_primary_database );

	RPbdb_Database*	c_secondary_database	=	NULL;
	C_RPBDB_DATABASE_OBJECT_DATABASE( rb_secondary_database, c_secondary_database );

	if ( c_secondary_database == NULL )	{
		
		c_secondary_database	=	RPbdb_Database_internal_configureDatabaseInstanceForSecondaryIndexOnPrimaryDatabase(	c_primary_database,
	...
	RPbdb_Database_createSecondaryIndexWithDatabase(	c_primary_database,
														c_secondary_database,
														c_index_method_string,
														& rb_RPbdb_DatabaseObject_internal_secondaryKeyCreationCallbackMethod );
...
RPBDB_SECONDARY_KEY_CREATION_RETURN rb_RPbdb_DatabaseObject_internal_secondaryKeyCreationCallbackMethod(	RPbdb_Database*				c_secondary_database, 
	...
	VALUE	rb_self	=	rb_RPbdb_DatabaseObject_internal_extractRetrievalData( c_record );
...
VALUE rb_RPbdb_DatabaseObject_internal_identifiesWithCurrentlyOpenEnvironment(	VALUE	rb_klass_self,
																																							VALUE	rb_environments_hash )	{
	
	VALUE	rb_identifiers	=	rb_RPbdb_DatabaseObject_internal_identifiers( rb_klass_self );
	...
	//	iterate RPbdb.environments as environment => identify_for_rpbdb_as
	rb_hash_foreach(	rb_environments_hash, 
										rb_RPbdb_DatabaseObject_internal_iterateEnvironments,
										rb_passed_args );
	...
	if (	rb_passed_args == Qnil
		||	rb_RPbdb_DatabaseObject_internal_initWithDefaultEnvironment(	rb_klass_self ) )	{
		return Qtrue;
	}
...
VALUE rb_RPbdb_DatabaseObject_internal_identifiersAllowDefaultEnvironment(	VALUE	rb_self )	{

	VALUE	rb_identifiers		=	rb_RPbdb_DatabaseObject_internal_identifiers( rb_self );
...
VALUE rb_RPbdb_DatabaseObject_internal_initWithDefaultEnvironment(	VALUE	rb_klass_self )	{

	//	check if rb_identifiers is nil or empty or if RPbdb::Default is in rb_identifiers- if not, return Qfalse
	if ( rb_RPbdb_DatabaseObject_internal_identifiersAllowDefaultEnvironment( rb_klass_self ) )	{
	
		//	if it is, get the default environment and return a ruby-wrapped version
		RPbdb_Environment*	c_current_working_environment	=	RPbdb_RuntimeStorageController_currentWorkingEnvironment( RPbdb_RuntimeStorageController_sharedInstance() );
		
		VALUE	rb_current_working_environment	=	RUBY_RPBDB_ENVIRONMENT( c_current_working_environment );
...
static int rb_RPbdb_DatabaseObject_internal_iterateEnvironments(	VALUE	rb_environment,
	...
	int	which_identifier;
	for ( which_identifier = 0 ; which_identifier < RARRAY_LEN( rb_identify_for_rpbdb_as_array ) ; which_identifier++ )	{

		VALUE	rb_identifier_string	=	RARRAY_PTR( rb_identify_for_rpbdb_as_array )[ which_identifier ];

		//	ask if environment.identifies_as( Const )
		//	we're looking for one of the identifiers - the first one is our environment
		if (  rb_RPbdb_Environment_identifiesAs(	1,
													& rb_identifier_string,
													rb_environment ) )	{
			
			rb_RPbdb_DatabaseObject_internal_configureWithEnvironment(	rb_klass,
																		rb_environment );
...
VALUE rb_RPbdb_DatabaseObject_internal_activateClass(	VALUE	rb_klass_self )	{
	
	//	activateModuleClass is called when the class has included or extended RPbdb,
	
	//	if we have RPbdb included/extended
	//	then we register the class with RPbdb
	//	if we load a new environment and an RPbdb class is included/extended
	...
	VALUE	rb_environments_hash	=	rb_RPbdb_internal_environmentsToIdentifiersHash();
	...
	if ( RHASH_SIZE( rb_environments_hash ) > 0 )	{
		...
		if (	rb_identifiers != Qnil )	{
			...
			if ( RARRAY_LEN( rb_identifiers ) > 0 )	{
				...
				if ( rb_RPbdb_DatabaseObject_internal_identifiesWithCurrentlyOpenEnvironment(	rb_klass_self,
																																											rb_environments_hash ) == Qfalse )	{
					
					//	otherwise, check if object identifies with RPbdb::Default
					if ( rb_RPbdb_DatabaseObject_internal_initWithDefaultEnvironment( rb_klass_self ) == Qfalse )	{
						
						rb_RPbdb_DatabaseObject_internal_addToAppropriateWaitlist( rb_klass_self );
						return Qfalse;
					}
				}
			}
		...
		//	no identifiers; see if we have a default environment
			...
			//	check if object identifies with RPbdb::Default
			if ( rb_RPbdb_DatabaseObject_internal_initWithDefaultEnvironment( rb_klass_self ) == Qfalse )	{
...
VALUE rb_RPbdb_DatabaseObject_internal_addToAppropriateWaitlist( VALUE	rb_klass_self )	{
		
	if ( rb_RPbdb_DatabaseObject_internal_identifiersAllowDefaultEnvironment( rb_klass_self ) )	{
		//	add to default waitlist if appropriate
		rb_RPbdb_DatabaseObject_internal_markForDefaultEnvironment( rb_klass_self );
	}
	//	if we are adding to default waitlist we don't need to worry about identifiers, since the next db will match
	else {
		rb_RPbdb_DatabaseObject_internal_markForIdentification( rb_klass_self );
	}
	return rb_klass_self;
}
...
VALUE rb_RPbdb_DatabaseObject_internal_configureWithEnvironment(	VALUE	rb_klass_self,
																																VALUE	rb_environment )	{
	
	//	if it does, set the environment for the class
	rb_RPbdb_DatabaseObject_setEnvironment(	rb_klass_self,
																					rb_environment );
	
	//	and call configureRPbdb
	rb_funcall(	rb_klass_self,
							rb_intern( RPBDB_FUNCTION_CONFIGURE ),
							0 );

	//	mark for init (happens after all waiting classes have configured)
	rb_RPbdb_DatabaseObject_internal_markForInitialization( rb_klass_self );

	//	mark as initialized for this environment; when environment closes, classes will go back on wait lists
	rb_RPbdb_Environment_internal_markClassConfigured(	rb_environment,
																										rb_klass_self );
...
VALUE rb_RPbdb_DatabaseObject_internal_ensureInitialized( VALUE	rb_self )	{

	VALUE	rb_klass		=	( ( TYPE( rb_self ) == T_CLASS ) ? rb_self : rb_funcall( rb_self, rb_intern( "class" ), 0 ) );

	//	Make sure we have an environment or fail
	rb_RPbdb_DatabaseObject_requireEnvironment( rb_klass );
	
	//	Make sure class is initialized or initialize it
	if ( ! rb_RPbdb_DatabaseObject_hasInitialized( rb_klass ) )	{
		
		rb_RPbdb_DatabaseObject_internal_callInitRPbdb( rb_klass );
	}
...
VALUE rb_RPbdb_DatabaseObject_internal_setHasConfigured(	VALUE	rb_klass_self,
...
VALUE rb_RPbdb_DatabaseObject_internal_setHasInitialized(	VALUE	rb_klass_self,
																													VALUE	rb_true_or_false  )	{
	rb_iv_set(	rb_klass_self,
							RPBDB_RB_VARIABLE_INITIALIZED,
							rb_true_or_false );	
...
VALUE rb_RPbdb_DatabaseObject_internal_markForDefaultEnvironment( VALUE rb_klass_self )	{
...
VALUE rb_RPbdb_DatabaseObject_internal_markForIdentification( VALUE rb_klass_self )	{
	
	//	get initWaitList array from module
	VALUE	rb_identification_wait_list	=	rb_RPbdb_internal_classesWaitingForIdentification();
...
VALUE rb_RPbdb_DatabaseObject_internal_markForInitialization( VALUE rb_klass_self )	{
	
	//	get initWaitList array from module
	VALUE	rb_initialization_wait_list	=	rb_RPbdb_internal_classesWaitingForInitialization();
...
VALUE rb_RPbdb_DatabaseObject_internal_identifiers( VALUE rb_self )	{

	VALUE	rb_identifiers	=	rb_funcall(	rb_self,
																			rb_intern( RPBDB_FUNCTION_IDENTIFY_AS ),
																			0 );
...
//	This should also make it unnecessary to call super in initRPbdb
VALUE rb_RPbdb_DatabaseObject_internal_callInitRPbdb( VALUE rb_self )	{
	
	//	Mark that we have initialized
	rb_RPbdb_DatabaseObject_internal_setHasInitialized(	rb_self,
														Qtrue );
...
VALUE rb_RPbdb_DatabaseObject_internal_uniqueJoinDeclarationHash( VALUE rb_self )	{
	
	VALUE	rb_unique_join_declaration_hash	=	rb_iv_get(	rb_self,
														  RPBDB_RB_VARIABLE_UNIQUE_JOIN_DECLARATION_HASH );
...
void rb_RPbdb_DatabaseObject_internal_addChainedMember(	VALUE	rb_hash_self,
